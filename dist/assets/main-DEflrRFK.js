...
`}},settings:{optimizer:{enabled:!0,runs:200},evmVersion:"paris",outputSelection:{"*":{"*":["abi","evm.bytecode","evm.deployedBytecode","evm.methodIdentifiers","metadata"],"":["ast"]}}}},yi={runs:200},xi="paris",dt={contractName:pi,compilerVersion:hi,standardJsonInput:mi,optimizer:yi,evmVersion:xi},vi=document.querySelector("#app"),oe={chainId:4663,chainIdHex:"0x1237",chainName:"Robinhood Chain",get rpcUrl(){return`${window.location.origin}/rpc`},router:"0x89e5db8b5aa49aa85ac63f691524311aeb649eba",currencySymbol:"ETH",blockExplorerUrl:"https://robinhoodchain.blockscout.com/",blockscoutApiUrl:"https://robinhoodchain.blockscout.com/api"},y={provider:null,signer:null,contract:null,address:"",walletMode:"",activeFunctionTab:"wallets",generatedWallets:[],lastDeployTxHash:""},B={running:!1,config:null,provider:null,wallets:[],reactiveWallets:[],balances:{},stats:{startedAt:null,totalBuys:0,totalSells:0,reactiveSells:0,totalBuyVolumeEth:0,successfulTrades:0,failedTrades:0,cyclesCompleted:0,lastTradeAt:null,lastError:null},trades:[],loopTimeout:null,reactiveFilter:null},xe={wallets:[],revealed:!1,loading:!1,log:[]},l={},wi=ue.abi.filter(e=>e.type==="function"&&e.stateMutability!=="view"&&e.stateMutability!=="pure"),gi=ue.abi.filter(e=>e.type==="function"&&(e.stateMutability==="view"||e.stateMutability==="pure")),$i=[{id:"accounts",label:"Accounts",icon:"👥"},{id:"multisend",label:"Multisend",icon:"📤"},{id:"sweep",label:"Collect ETH",icon:"🧹"},{id:"mmBot",label:"Market Maker Bot",icon:"🤖"},{id:"wallets",label:"Wallets",icon:"🗂️"},{id:"projectMgmt",label:"Project Management",icon:"📁"},{id:"disperse",label:"Disperse",icon:"🌐"},{id:"walletWash",label:"Wallet Wash",icon:"🔄"},{id:"walletReport",label:"Check Balance",icon:"📋"},{id:"launch",label:"Launch Planner",icon:"🧮"},{id:"pons",label:"Pons Launch",icon:"🚀"},{id:"ponsWash",label:"Pons + Wash",icon:"🔁"},{id:"multiBuys",label:"Multiple Buys",icon:"🛒"},{id:"lunch",label:"Lunch.fun Launch",icon:"🍽️"},{id:"lunchBurst",label:"Lunch Burst",icon:"💥"},{id:"lunchCombo",label:"Lunch + Burst",icon:"⚡"},{id:"doppler",label:"Feel Cash",icon:"🌀"},{id:"verify",label:"Verify",icon:"✅"}],we=["function WETH() external pure returns (address)","function factory() external pure returns (address)","function swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 amountOutMin, address[] calldata path, address to, uint256 deadline) external payable","function swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 amountIn, uint256 amountOutMin, address[] calldata path, address to, uint256 deadline) external","function addLiquidityETH(address token, uint256 amountTokenDesired, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline) external payable returns (uint256 amountToken, uint256 amountETH, uint256 liquidity)","function removeLiquidityETHSupportingFeeOnTransferTokens(address token, uint256 liquidity, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline) external returns (uint256 amountETH)","function getAmountsOut(uint256 amountIn, address[] calldata path) external view returns (uint256[] memory amounts)"],ki=["function getPair(address tokenA, address tokenB) external view returns (address pair)"],Si=["function getReserves() external view returns (uint112 reserve0, uint112 reserve1, uint32 blockTimestampLast)","function token0() external view returns (address)","function token1() external view returns (address)"],Ei=["function approve(address spender, uint256 value) external returns (bool)","function allowance(address owner, address spender) external view returns (uint256)","function balanceOf(address account) external view returns (uint256)"],je={name:"Robinhood Chain",id:4663,explorerUrl:"https://robinhoodchain.blockscout.com/",launchContract:"0xF4fC0CD27fC8EcF17E55eE4c3f7201897dF3eb75"},ur=["function dexConfigCount() view returns (uint256)","function launchConfigCount() view returns (uint256)","function getDexConfig(uint256 id) view returns (tuple(string name,address factory,address positionManager,address swapRouter,uint24 poolFee,int24 tickSpacing,bool enabled))","function getLaunchConfig(uint256 id) view returns (tuple(address pairToken,uint256 graduationThreshold,int24 initialTick,uint256 supply,uint16 maxWalletBps,uint16 maxTxBps,uint32 restrictionBlocks,uint24 reservedFee,bool enabled,bool routerRequiresDeadline))","function getLaunchedToken(address token) view returns (tuple(address token,address deployer,address pairedToken,address positionManager,uint256 positionId,uint256 dexId,uint256 launchConfigId,uint256 restrictionsEndBlock,uint256 supply,bool isToken0,uint24 poolFee,bool exists,uint256 initialBuyAmount))","function launchEnabled() view returns (bool)","function launchFee() view returns (uint256)","function locker() view returns (address)","function predictTokenAddress((string name,string symbol,string logo,string description,(string twitter,string telegram,string discord,string website,string farcaster) socials,address feeWallet) params,uint256 launchConfigId,uint256 dexId,bytes32 salt,address tokenDeployer) view returns (address)","function launchToken((string name,string symbol,string logo,string description,(string twitter,string telegram,string discord,string website,string farcaster) socials,address feeWallet) params,uint256 launchConfigId,uint256 dexId,bytes32 salt) payable returns (address token)","event TokenLaunched(address indexed token,address indexed deployer,address indexed dexFactory,address pairToken,address pool,uint256 dexId,uint256 launchConfigId,uint256 positionId,uint256 restrictionsEndBlock,uint256 initialBuyAmount)","function owner() view returns (address)","function whitelistedLaunchers(address launcher) view returns (bool)","function setLaunchEnabled(bool enabled) external","function setWhitelistedLauncher(address launcher, bool enabled) external"],br=["function getPool(address tokenA, address tokenB, uint24 fee) view returns (address pool)"],Pa=["function slot0() view returns (uint160 sqrtPriceX96,int24 tick,uint16,uint16,uint16,uint8,bool)","function liquidity() view returns (uint128)","function token0() view returns (address)","function token1() view returns (address)"],Ia=["function balanceOf(address account) view returns (uint256)","function withdraw(uint256 amount)"],Re=["function exactInputSingle((address tokenIn,address tokenOut,uint24 fee,address recipient,uint256 amountIn,uint256 amountOutMinimum,uint160 sqrtPriceLimitX96) params) payable returns (uint256 amountOut)","function exactInputSingle((address tokenIn,address tokenOut,uint24 fee,address recipient,uint256 deadline,uint256 amountIn,uint256 amountOutMinimum,uint160 sqrtPriceLimitX96) params) payable returns (uint256 amountOut)"],mn=["function balanceOf(address account) view returns (uint256)","function decimals() view returns (uint8)","function liquidityPool() view returns (address)","function restrictionEndBlock() view returns (uint256)","function maxWalletLimit() view returns (uint256)","function maxTxLimit() view returns (uint256)"];function fr(){return{factory:null,dexConfig:null,launchConfig:null,launchFee:0n,launchEnabled:!1,locker:"",predictedToken:"",launchedToken:"",launchedPool:"",restrictionsEndBlock:0n,owner:"",isOwner:!1}}const pr=fr(),pa={"":pr};function ot(e=""){return pa[e]||(pa[e]=fr()),pa[e]}const U={name:"Robinhood Chain",id:4663,explorerUrl:"https://robinhoodchain.blockscout.com/",launchContract:"0xf5Ac14e7691EF44b15b59FcC6a756e41A3E5EFd6",implementation:"0xc419ba7b9c32103ab8b1a04de4ea2ed518e03749",router:"0xCaf681a66D020601342297493863E78C959E5cb2",atomicExecutor:"0xCE5D2591C5601c639813c84c169F15c24c3DAe31",delegate7702:"0xeC3982E8fB11FA941F73a98Ec7E37d103989C8D6",coordinator7702:"0x25373dEf200d9db41ee3691F8534B8133685ED9d"},hr=["function factory() view returns (address)","function npm() view returns (address)","function xToken() view returns (address)","function feeLocker() view returns (address)","function launchFeeWei() view returns (uint256)","function enforcedSupply() view returns (uint256)","function launchTickMagnitude() view returns (int24)","function midBandTicks() view returns (int24)","function band1DepthWei() view returns (uint256)","function allTokensLength() view returns (uint256)","function predictTokenAddress(string name,string symbol,uint256 totalSupply,address creator,bytes32 userSalt) view returns (address)","function launchWithMetaSalt(string name,string symbol,uint256 totalSupply,uint24 fee,uint256 initialBuyMaxTokens,(string image,string banner,string description,string website,string twitter,string telegram) meta,bytes32 userSalt) payable returns (address token,uint256 tokenId)","event V3TokenLaunched(address indexed token,uint256 indexed tokenId,address indexed creator,address pool,uint24 fee)","event V3BandsLaunched(address indexed token,uint256 curveTokenId,uint256 tailTokenId,int24 launchTick,int24 midTick,uint256 band1Tokens,uint256 band2Tokens)","event V3SaltedLaunch(address indexed token,bytes32 userSalt)","event V3TokenMeta(address indexed token,address indexed creator,string image,string banner,string description,string website,string twitter,string telegram)"],mr=["function owner() view returns(address)","function launcher() view returns(address)","function delegateImplementation() view returns(address)","function launchAndBuy((string name,string symbol,uint256 totalSupply,uint24 fee,(string image,string banner,string description,string website,string twitter,string telegram) meta,bytes32 userSalt,uint256 deadline) params,(address account,uint256 amountIn,uint256 amountOutMinimum,uint160 sqrtPriceLimitX96,uint256 nonce,bytes signature)[] buyers) payable returns(address,uint256,uint256[])"],Ti=["function coordinator() view returns(address)","function router() view returns(address)","function xToken() view returns(address)","function executionNonce() view returns(uint256)"],yr=600000n,xr=550000n,Bi="https://sequencer.mainnet.chain.robinhood.com",Cn=1000000n,Ci=15000n,ye={factory:null,factoryAddress:"",npm:"",xToken:"",feeLocker:"",launchFee:0n,enforcedSupply:0n,predictedToken:"",launchedToken:"",launchedPool:""},j={name:"Robinhood Chain",id:4663,explorerUrl:"https://robinhoodchain.blockscout.com/",airlock:"0xeb7C034704eF8Dcd2D32324c1545f62fB4aD0862",tokenFactory:"0x0Bd7D308f8E1639FAb988df18A8011f41EAcAD73",governanceFactory:"0x1B37D3a72082029c44B35B604Ea473617580b69a",poolInitializer:"0x4e3468951D49f2EEa976eD0D6e75fFCb44a9a544",liquidityMigrator:"0x4035f7cce90d78307420a987a9e084bfbdc83e2b",numeraire:"0xba2F330EDb16cD8056f5988d8CE19BbC63475A0e",universalRouter:"0x8876789976dEcBfCbBbe364623C63652db8C0904",poolManager:"0x8366a39CC670B4001A1121B8F6A443A643e40951",hooks:"0x4e3468951D49f2EEa976eD0D6e75fFCb44a9a544",tickSpacing:200,dynamicFeeFlag:8388608,atomicExecutor:""},vr=["function getModuleState(address module) view returns (uint8)","function getAssetData(address asset) view returns (address numeraire,address timelock,address governance,address liquidityMigrator,address poolInitializer,address pool,address migrationPool,uint256 numTokensToSell,uint256 totalSupply,address integrator)","function create((uint256 initialSupply,uint256 numTokensToSell,address numeraire,address tokenFactory,bytes tokenFactoryData,address governanceFactory,bytes governanceFactoryData,address poolInitializer,bytes poolInitializerData,address liquidityMigrator,bytes liquidityMigratorData,address integrator,bytes32 salt) createData) returns (address asset,address pool,address governance,address timelock,address migrationPool)","event Create(address asset,address indexed numeraire,address initializer,address poolOrHook)"],Ri=["function execute(bytes commands, bytes[] inputs, uint256 deadline) payable"],Ai="0x10",Li=6,Pi=11,Ii=14,Mi="tuple(address currency0,address currency1,uint24 fee,int24 tickSpacing,address hooks)",Di=["function owner() view returns (address)","function airlock() view returns (address)","function router() view returns (address)","function hooks() view returns (address)","function tickSpacing() view returns (int24)","function launchAndBuy((uint256 initialSupply,uint256 numTokensToSell,address numeraire,address tokenFactory,bytes tokenFactoryData,address governanceFactory,bytes governanceFactoryData,address poolInitializer,bytes poolInitializerData,address liquidityMigrator,bytes liquidityMigratorData,address integrator,bytes32 salt) createData,(address recipient,uint256 amountIn,uint256 amountOutMinimum)[] buys,bool numeraireIsNative,uint256 deadline) payable returns (address asset,address pool)","event AtomicLaunch(address indexed asset,address indexed pool,address indexed controller,uint256 buyCount)","event AtomicBuy(address indexed asset,address indexed recipient,uint256 amountIn,uint256 amountOutMinimum)"],on={predictedAsset:"",launchedAsset:"",launchedPool:""};function R(e){return e?e.length>18?`${e.slice(0,10)}...${e.slice(-6)}`:e:""}function wr(e){return e.trim()?e.split(",").map(t=>t.trim()).filter(Boolean):[]}function Fi(e,t){return e.type.endsWith("[]")?wr(t):e.type==="bool"?t===!0||t==="true":t.trim()}function gt(e,t){const n=String(e??"").trim().split(/\s+/)[0];if(!n)throw new Error(`${t} is required.`);if(!/^\d+(\.\d+)?$/.test(n))throw new Error(`${t} must be a plain number, for example 1000 or 0.25.`);return n}function _t(e,t,n){return Ce(gt(e,n),t)}function me(e,t){return ce(gt(e,t))}function x(e,t="",n="text"){return`<input id="${q(e)}" type="${q(n)}" placeholder="${q(t)}" autocomplete="off" />`}function ge(e,t=""){return`<textarea id="${q(e)}" placeholder="${q(t)}"></textarea>`}function Ln(e,t){return`
  ...
  `}function Wi(){for(const e of document.querySelectorAll("[data-token-image-drop]")){const t=e.dataset.tokenImageDrop,n=document.querySelector(`#${t}`),a=e.querySelector(".token-image-drop-box"),r=e.querySelector(`[data-token-image-drop-value="${t}"]`);if(!n||!a||!r)continue;const o=()=>{const s=n.value.trim().length>0;a.classList.toggle("has-value",s),r.textContent=s?n.value.trim():""};o(),n.addEventListener("input",o)}}function gr(e=""){return`
          ...
          <div class="grid two">
            <label>Expected chain <input readonly value="${je.name} (${je.id})" /></label>
          ...
          <div class="grid two">
            <label>Launch contract <input id="${e}ponsLaunchContract" readonly value="${je.launchContract}" /></label>
          ...
          <h2 class="section-gap">${n} (${Ue} wallets, not atomic)</h2>
  ...
  `}function Oi(e=""){return["Primary wallet"].map((n,a)=>`
  ...
  `).join("")}const Ni=4e3,s0=3,qi=3e3,Ue=15,et=[{prefix:"ponsBurst1",label:"Burst 1"},{prefix:"ponsBurst2",label:"Burst 2"},{prefix:"ponsBurst3",label:"Burst 3"}];function Hi(e,t=""){const n=(r,o)=>`${t}${e}Buyer${r}${o}`;return Array.from({length:Ue},(r,o)=>`Buyer wallet ${o+1}`).map((r,o)=>`
    <article class="function-card buyer-row">
      <div class="function-head">
        <strong>${o+1}. ${r}</strong>
  ...
  `).join("")}function ji(){const e=(n,a)=>`multiBurstBuyer${n}${a}`;return Array.from({length:25},(n,a)=>`Buyer wallet ${a+1}`).map((n,a)=>`
    <article class="function-card buyer-row">
      <div class="function-head">
        <strong>${a+1}. ${n}</strong>
  ...
  `).join("")}function Ui(){const e=(n,a)=>`dopplerBuyer${n}${a}`;return["Creator / first-buy recipient","Buyer wallet 2","Buyer wallet 3","Buyer wallet 4","Buyer wallet 5"].map((n,a)=>`
    <article class="function-card buyer-row">
      <div class="function-head">
        <strong>${a+1}. ${n}</strong>
        <span>order ${a+1}</span>
...
0x_private_key`)}</label>
  ...
  `}const qe={rows:[],tokenAddress:"",tokenSymbol:"",totalSupply:0};function kr(){const e=qe.rows,t=e.reduce((o,s)=>o+s.eth,0),n=e.reduce((o,s)=>o+s.token,0),a=e.reduce((o,s)=>o+s.pctSupply,0),r=C.projects.find(o=>o.id===C.activeProjectId);return`
    <h2>Check Balance</h2>
...
0x_private_key`)}
  ...
  `}function Tr(){const e=document.querySelector("#launchPlanResults"),t=Number(l.launchPlanBudget.value),n=Number(l.launchPlanWalletCount.value),a=0,r=1e9,o=3450,s=93400,i=5,c=3;if(![t,a,n,r,o,s,i,c].every(Number.isFinite)){e.innerHTML='<p class="result error">Enter numbers in every planning field.</p>';return}if(t<=0||a<0||a>=t||!Number.isInteger(n)||n<=0||r<=0||o<=0||s<o||i<=0||c<=0){e.innerHTML='<p class="result error">Check the values: budget must exceed reserve, wallet count must be positive, market caps must be positive, and the wallet limit must be greater than zero.</p>';return}const u=t-a,d=u/n,b=i/100,f=D=>o+(s-o)*D**c,p=[];let h=0,m=0;for(let D=0;D<n&&m<1-Number.EPSILON;D+=1){const I=m,H=Math.min(1,I+b),V=z=>(f(I)+f(z))/2*(z-I);let F=I,$=H;for(let z=0;z<60;z+=1){const Z=(F+$)/2;V(Z)<=d?F=Z:$=Z}const W=F,ae=V(W);if(W<=I+Number.EPSILON)break;h+=ae,m=W,p.push({index:D+1,walletCost:ae,walletPct:(W-I)*100,cumulativeFunds:h,marketCap:f(W),cumulativePct:m*100})}const v=r*m,g=r-v,k=f(m),T=o/r,S=k/r,E=(D,I=2)=>D.toLocaleString(void 0,{maximumFractionDigits:I}),L=D=>`$${D.toFixed(8)}`,M=p.length<n&&m<1;e.innerHTML=`
    ...
    <div class="launch-planner-details">
      ...
      <div><span>Final market cap</span><strong>$${E(k,2)}</strong></div>
  ...
  `}function Gi(){l.launchPlanBudget.value="6900",l.launchPlanWalletCount.value="100",Tr()}function Br(e){var s,i;const t=le.expanded.has(e.id),n=le.counts[e.id],a=n?nt.map(c=>`${n[c.id]??0} ${c.label.replace(" Wallets","").replace("Wallet Wash — ","")}`).join(" · "):"Loading counts...",r=e.id===C.activeProjectId,o=C.canManageProjects?`<div class="project-mgmt-token-row">
  ...
  `:`
    ...
    `}function c0(){return C.canManageProjects?`
    <div class="function-card section-gap">
  ...
  `:""}function Lr(){var n;const e=C.projects.find(a=>a.id===C.activeProjectId),t=((n=e==null?void 0:e.config)==null?void 0:n.platform)||"";return`
...
0x_private_key`)}
  ...
  `}function Kr(){const e=B.stats,t=e.startedAt?Date.now()-e.startedAt:0,n=e.successfulTrades+e.failedTrades>0?`${Math.round(e.successfulTrades/(e.successfulTrades+e.failedTrades)*100)}%`:"--",a=Object.values(B.balances).reduce((o,s)=>({eth:o.eth+(s.eth||0),token:o.token+(s.token||0)}),{eth:0,token:0}),r=B.wallets.length;return`
    <div class="mmbot-grid">
      <div class="mmbot-col">
        <div class="function-card mmbot-card">
          <div class="function-head">
            <strong>Market Maker Bot</strong>
            <span class="mmbot-badge ${B.running?"running":"stopped"}">${B.running?"RUNNING":"STOPPED"}</span>
          </div>
...
0x_private_key`)}</label>
        ...
        <button id="mmStartStop" class="mmbot-start-btn">${B.running?"Stop Bot":"Start Bot"}</button>
      </div>
      ...
      <div class="mmbot-col">
        <div class="function-card mmbot-card">
          ...
          <div class="mmbot-stats-grid">
            ${Oe("Uptime",B.running||t>0?Vr(t):"--","","data-mm-uptime")}
            ${Oe("Cycles",e.cyclesCompleted)}
            ${Oe("Total Buys",e.totalBuys,"good")}
            ${Oe("Total Sells",e.totalSells,"bad")}
            ${Oe("Reactive Sells",e.reactiveSells,"accent")}
            ${Oe("Buy Vol (ETH)",P(e.totalBuyVolumeEth))}
            ${Oe("Success Rate",n)}
            ${Oe("Wallets",r)}
            ${Oe("ETH Balance",r?P(a.eth):"--")}
            ${Oe("Token Balance",r?P(a.token):"--")}
          </div>
        ...
        <div class="function-card mmbot-card section-gap">
          <div class="function-head">
            ...
            <span class="mmbot-badge accent">${B.trades.length}</span>
          </div>
          <div class="mmbot-log" id="mmTradeLog">
            ${B.trades.length===0?'<p class="hint">Bot not started</p>':B.trades.map(ol).join("")}
          </div>
        </div>
      </div>
    </div>
  `}function Oe(e,t,n="",a=""){return`<div class="mmbot-stat"><span>${e}</span><strong class="${n}" ${a}>${t}</strong></div>`}function rl(){const e=B.config;return e?e.poolVersion==="v3"?`${R(e.v3PoolAddress)} (V3)`:e.pairAddress?`${R(e.pairAddress)} (V2)`:"Checked at start":"Checked at start"}function ol(e){const t=new Date(e.time).toLocaleTimeString(),n=e.status==="success"?"good":e.status==="skipped"?"":"bad",a=e.status==="success"?`${P(e.amount)} ${e.unit}${e.hash?` · ${R(e.hash)}`:""}`:e.error||e.status;return`<div class="mmbot-log-row ${n}">
  ...
  </div>`}function Vr(e){const t=Math.floor(e/1e3),n=Math.floor(t/3600),a=Math.floor(t%3600/60),r=t%60;return`${String(n).padStart(2,"0")}:${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function P(e){const t=Number(e||0);return Number(t.toFixed(6)).toString()}function sn(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;")}function Nn(e){const t=Number(e.min)||0,n=Number(e.max)||100,a=(Number(e.value)-t)/(n-t)*100;e.style.setProperty("--range-fill",`${a}%`)}function sl(e){const t=Number(l.mmBuyWeight.value);document.querySelector("#mmBuyWeightLabel").textContent=`Buy: ${t}% / Sell: ${100-t}%`,Nn(e?e.currentTarget:l.mmBuyWeight)}function il(e){document.querySelector("#mmTxnsLabel").textContent=l.mmTxnsPerUnit.value,Nn(e?e.currentTarget:l.mmTxnsPerUnit)}const Gr=["mmTokenAddress","mmWalletKeys","mmGenerateCount","mmImportFile","mmFundingKey","mmFundAsset","mmFundMode","mmFundAmount","mmMinBuy","mmMaxBuy","mmMinSellPct","mmMaxSellPct","mmSellHardcap","mmBuyWeight","mmIntervalUnit","mmTxnsPerUnit","mmSlippage","mmGasPrice","mmMinReserve","mmReactiveEnabled","mmReactivePct","mmReactiveMaxTokens","mmReactiveKeys"];function zr(){const e=document.querySelector('[data-tab-panel="disperse"]');e&&(e.innerHTML=Ur(),Yr())}const Xr=["disperseGenerateCount","disperseGenerateLabel","disperseSourceKey","disperseAsset","disperseTokenAddress","disperseMode","disperseAmount","hopSourceKey","hopRelayCount","hopTotalAmount","hopDelayRange","hopVariancePct","hopGasReserve"];function ll(){for(const e of Xr)l[e]=document.querySelector(`#${e}`)}function Yr(){ll(),document.querySelector("#disperseGenerate").addEventListener("click",fl),document.querySelector("#disperseLoadWallets").addEventListener("click",()=>vt(!1)),document.querySelector("#disperseRevealKeys").addEventListener("click",()=>vt(!0)),document.querySelector("#disperseExportJson").addEventListener("click",()=>u0("json")),document.querySelector("#disperseExportCsv").addEventListener("click",()=>u0("csv")),document.querySelector("#disperseRun").addEventListener("click",hl),document.querySelector("#hopFundRun").addEventListener("click",cl);for(const e of document.querySelectorAll(".disperse-delete"))e.addEventListener("click",()=>pl(e.dataset.address))}function tt(e){return new Promise(t=>setTimeout(t,e))}function qn(e,t,n){const a=[];let r=e;for(let o=0;o<t;o+=1){if(o===t-1){a.push(Math.max(0,r));break}const s=r/(t-o),i=s*(n/100),c=Math.max(0,s+(Math.random()*2-1)*i);a.push(c),r-=c}return a}function xt(e){const[t,n]=e.split("-").map(o=>o.trim()),a=Math.max(0,parseFloat(t)||0),r=Math.max(a,parseFloat(n)||a);return Math.floor((a+Math.random()*(r-a))*1e3)}async function cl(){const e=document.querySelector("#hopFundResult"),t=[],n=a=>{t.push(`[${new Date().toLocaleTimeString()}] ${a}`),e.textContent=t.join(`
`),w(`Multi-Hop Fund: ${a}`)};try{const a=l.hopSourceKey.value.trim();if(!a)throw new Error("Enter the source wallet's private key.");const r=Math.max(2,Math.min(6,parseInt(l.hopRelayCount.value)||3)),o=parseFloat(l.hopTotalAmount.value);if(!o||o<=0)throw new Error("Enter a total ETH amount greater than zero.");const s=Math.max(0,Math.min(90,parseFloat(l.hopVariancePct.value)||15)),i=Math.max(0,parseFloat(l.hopGasReserve.value)||5e-4),c=l.hopDelayRange.value.trim()||"20-90";if(xe.wallets.length===0&&(n("Loading saved wallets first..."),await vt(!1)),xe.wallets.length===0)throw new Error("No saved wallets found. Generate some in the Saved Wallets section first.");const u=te(),d=new K(a,u),b=Array.from({length:r},()=>K.createRandom().connect(u));n(`Generated ${r} disposable relay wallet(s): ${b.map(v=>R(v.address)).join(", ")}`),n(`Hop 1/2: source ${R(d.address)} → ${r} relay(s), total ${P(o)} ETH, randomized ±${s}% per send, ${c}s delay between sends.`);const f=qn(o,r,s);for(const[v,g]of b.entries()){const k=f[v];if(k<=0)continue;const T=await d.sendTransaction({to:g.address,value:ce(P(k))});if(n(`  → relay ${v+1} (${R(g.address)}): ${P(k)} ETH — ${T.hash}`),await T.wait(),v<b.length-1){const S=xt(c);n(`  waiting ${(S/1e3).toFixed(1)}s before next hop-1 send...`),await tt(S)}}n(`Hop 2/2: each relay → a shuffled share of the ${xe.wallets.length} saved wallet(s), reserving ${i} ETH per relay for its own gas.`);const p=[...xe.wallets].sort(()=>Math.random()-.5),h=[];for(let v=0;v<r;v+=1)h.push([]);p.forEach((v,g)=>h[g%r].push(v));let m=0;for(const[v,g]of b.entries()){const k=h[v];if(k.length===0)continue;const T=Number(O(await u.getBalance(g.address))),S=Math.max(0,T-i);if(S<=0){n(`  relay ${v+1} (${R(g.address)}) has no spendable balance after gas reserve — skipping its ${k.length} target(s).`);continue}const E=qn(S,k.length,s);for(const[L,M]of k.entries()){const D=E[L];if(D<=0)continue;try{const H=await g.sendTransaction({to:M.address,value:ce(P(D))});n(`  relay ${v+1} → ${R(M.address)}: ${P(D)} ETH — ${H.hash}`),await H.wait(),m++}catch(H){n(`  relay ${v+1} → ${R(M.address)} failed: ${H.shortMessage||H.message}`)}const I=xt(c);await tt(I)}}n(`Done: funded ${m}/${xe.wallets.length} saved wallet(s) via ${r} relay hop(s).`),n(`Relay private keys (for sweeping any leftover dust — these were never saved anywhere): ${b.map(v=>`${R(v.address)}=${v.privateKey}`).join(" | ")}`)}catch(a){e.textContent=`${e.textContent}
Failed: ${A(a)}`.trim(),w(`Multi-Hop Fund failed: ${A(a)}`)}}const Jr=["balanceCheckKeys"];function dl(){for(const e of Jr)l[e]=document.querySelector(`#${e}`)}function d0(){const e=document.querySelector('[data-tab-panel="walletReport"]');e&&(e.innerHTML=kr(),Zr())}function Zr(){dl(),document.querySelector("#balanceCheckRun").addEventListener("click",bl),ul()}async function ul(){const e=document.querySelector("#balanceCheckSavedCount");if(!(!e||!C.activeProjectId))try{const t=await ve("/api/wallets?chain=evm"),n=await t.json();t.ok&&(qe.savedCount=n.wallets.length,e.textContent=String(n.wallets.length))}catch{}}async function bl(){var s;const e=document.querySelector("#balanceCheckStatus");if(!C.activeProjectId){e.textContent="Select a project first (top of the page).";return}const t=C.projects.find(i=>i.id===C.activeProjectId),n=(s=t==null?void 0:t.config.tokenAddress)==null?void 0:s.trim();if(!n||!Y(n)){e.textContent="This project has no valid token address set — add one in Users & Roles → Projects.";return}const a=Ke(l.balanceCheckKeys.value);e.textContent="Loading saved wallets for this project...";let r;try{if(a.length>0){e.textContent=`Saving ${a.length} new wallet(s) to the project vault...`;const u=await ve("/api/wallets/save",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({privateKeys:a,label:"balance-check"})}),d=await u.json();if(!u.ok)throw new Error(d.error||"Failed to save pasted wallets.");w(`Check Balance: saved ${d.wallets.length} new wallet(s) to the project vault.`),l.balanceCheckKeys.value=""}const i=await ve("/api/wallets?chain=evm"),c=await i.json();if(!i.ok)throw new Error(c.error||"Failed to load saved wallets.");r=c.wallets.map(u=>u.address),qe.savedCount=r.length}catch(i){e.textContent=A(i),w(`Check Balance failed: ${A(i)}`);return}if(r.length===0){e.textContent="No wallets saved in this project yet — paste some private keys above to add them.",d0();return}const o=te();e.textContent=`Checking ${r.length} wallet(s)...`;try{const i=new _(n,ue.abi,o);let c=18,u="TOKEN",d=0n;try{c=Number(await i.decimals())}catch{}try{u=await i.symbol()}catch{}try{d=await i.totalSupply()}catch{}const b=Number(X(d,c)),f=await Promise.all(r.map(async m=>{const[v,g]=await Promise.all([o.getBalance(m),i.balanceOf(m).catch(()=>0n)]),k=Number(O(v)),T=Number(X(g,c)),S=b>0?T/b*100:0;return{address:m,eth:k,token:T,pctSupply:S}}));qe.rows=f,qe.tokenAddress=n,qe.tokenSymbol=u,qe.totalSupply=b;const p=f.reduce((m,v)=>m+v.eth,0),h=f.reduce((m,v)=>m+v.pctSupply,0);e.textContent=`Checked ${f.length} wallet(s). Total ${P(p)} ETH, ${h.toFixed(4)}% of ${u} supply.`,w(`Check Balance: ${f.length} wallet(s) — total ${P(p)} ETH, ${h.toFixed(4)}% of supply.`),d0()}catch(i){e.textContent=A(i),w(`Check Balance failed: ${A(i)}`)}}async function fl(){const e=document.querySelector("#disperseWalletResult");if(!C.activeProjectId){e.textContent="Select a project first.";return}const t=Math.max(1,Math.min(200,parseInt(l.disperseGenerateCount.value)||10)),n=l.disperseGenerateLabel.value.trim();e.textContent=`Generating ${t} wallet(s) on the server...`;try{const a=await ve("/api/wallets/generate",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({count:t,label:n}),credentials:"same-origin"}),r=await a.json();if(!a.ok)throw new Error(r.error||"Wallet generation failed.");e.textContent=`Generated and saved ${r.wallets.length} wallet(s). Click "Load Saved Wallets" to see addresses, or "Reveal Private Keys" to see keys.`,w(`Disperse: generated ${r.wallets.length} wallet(s).`),await vt(!1)}catch(a){e.textContent=a.message,w(`Disperse generate failed: ${a.message}`)}}async function vt(e){const t=document.querySelector("#disperseWalletResult");if(!C.activeProjectId){t.textContent="Select a project first.";return}t.textContent=e?"Loading wallets with private keys...":"Loading saved wallets...";try{const n=await ve(`/api/wallets${e?"?reveal=1":""}`),a=await n.json();if(!n.ok)throw new Error(a.error||"Failed to load wallets.");xe.wallets=a.wallets,xe.revealed=e,t.textContent=`Loaded ${a.wallets.length} saved wallet(s).`,w(`Disperse: loaded ${a.wallets.length} wallet(s)${e?" with private keys":""}.`),zr()}catch(n){t.textContent=n.message,w(`Disperse load failed: ${n.message}`)}}async function pl(e){if(!window.confirm(`Remove ${R(e)} from the saved wallet vault? This cannot be undone.`))return;const t=document.querySelector("#disperseWalletResult");try{const n=await ve(`/api/wallets?address=${encodeURIComponent(e)}`,{method:"DELETE"}),a=await n.json();if(!n.ok)throw new Error(a.error||"Failed to remove wallet.");xe.wallets=xe.wallets.filter(r=>r.address.toLowerCase()!==e.toLowerCase()),t.textContent=`Removed ${R(e)}.`,w(`Disperse: removed wallet ${R(e)}.`),zr()}catch(n){t.textContent=n.message}}function u0(e){if(!C.activeProjectId){w("Disperse export failed: select a project first.");return}window.open(`/api/wallets/export?format=${e}&projectId=${encodeURIComponent(C.activeProjectId)}`,"_blank"),w(`Disperse: exported wallets as ${e.toUpperCase()}.`)}async function hl(){var p;const e=document.querySelector("#disperseRunResult"),t=l.disperseSourceKey.value.trim();if(!t){e.textContent="Enter the source wallet's private key.";return}if(xe.wallets.length===0&&(e.textContent="Loading saved wallets first...",await vt(!1),xe.wallets.length===0)){e.textContent="No saved wallets found. Generate some first.";return}const n=l.disperseAsset.value,a=l.disperseTokenAddress.value.trim()||((p=y.contract)==null?void 0:p.target);if(n==="token"&&!Y(a||"")){e.textContent="Enter a valid token address (or attach a contract first).";return}const r=parseFloat(l.disperseAmount.value);if(!r||r<=0){e.textContent="Enter an amount greater than zero.";return}const o=l.disperseMode.value,s=xe.wallets.map(h=>h.address),i=o==="split"?r/s.length:r,c=te();let u;try{u=new K(t,c)}catch(h){e.textContent=`Invalid source private key — ${h.message}`;return}e.textContent=`Sending ${P(i)} ${n==="eth"?"ETH":"token"} to ${s.length} saved wallet(s)...`,w(`Disperse: sending ${P(i)} ${n==="eth"?"ETH":"token"} each to ${s.length} wallet(s) from ${R(u.address)}.`);let d=null,b=18;if(n==="token"){d=new _(a,ue.abi,u);try{b=Number(await d.decimals())}catch{}}let f=0;for(const[h,m]of s.entries())try{const v=n==="eth"?await u.sendTransaction({to:m,value:ce(P(i))}):await d.transfer(m,Ce(P(i),b));await v.wait(),w(`Disperse ${h+1}/${s.length} to ${R(m)}: ${v.hash}`),f++}catch(v){w(`Disperse ${h+1}/${s.length} to ${R(m)} failed: ${v.shortMessage||v.message}`)}e.textContent=`Dispersed to ${f}/${s.length} wallet(s). Check log for hashes and failures.`}function At(){const e=document.querySelector('[data-tab-panel="mmBot"]');e&&(e.innerHTML=Kr(),ml(),Qr())}function ml(){for(const e of Gr)l[e]=document.querySelector(`#${e}`)}function Qr(){document.querySelector("#mmStartStop").addEventListener("click",$l),document.querySelector("#mmBuyWeight").addEventListener("input",sl),document.querySelector("#mmTxnsPerUnit").addEventListener("input",il),Nn(l.mmBuyWeight),Nn(l.mmTxnsPerUnit),document.querySelector("#mmGenerateWallets").addEventListener("click",vl),document.querySelector("#mmDownloadWallets").addEventListener("click",wl),document.querySelector("#mmImportFile").addEventListener("change",gl),document.querySelector("#mmFundWallets").addEventListener("click",()=>b0(!1)),document.querySelector("#mmFundAndStart").addEventListener("click",()=>b0(!0))}async function b0(e){var m;const t=document.querySelector("#mmFundResult"),n=l.mmFundingKey.value.trim();if(!n){t.textContent="Enter the funding wallet's private key.";return}const a=Ke(l.mmWalletKeys.value);if(a.length===0){t.textContent="Add bot wallets first (paste keys, generate, or import).";return}const r=l.mmTokenAddress.value.trim()||((m=y.contract)==null?void 0:m.target),o=l.mmFundAsset.value;if(o==="token"&&!Y(r||"")){t.textContent="Enter a valid Token Mint Address first — required to send tokens.";return}const s=parseFloat(l.mmFundAmount.value);if(!s||s<=0){t.textContent="Enter an amount greater than zero.";return}const c=l.mmFundMode.value==="split"?s/a.length:s,u=te();let d;try{d=new K(n,u)}catch(v){t.textContent=`Invalid funding private key — ${v.message}`;return}const b=a.map(v=>new K(v).address);t.textContent=`Sending ${P(c)} ${o==="eth"?"ETH":"token"} to ${b.length} wallet(s)...`,w(`Market Maker Bot: funding ${b.length} wallet(s) with ${P(c)} ${o==="eth"?"ETH":"token"} each from ${R(d.address)}.`);let f=null,p=18;if(o==="token"){f=new _(r,ue.abi,d);try{p=Number(await f.decimals())}catch{}}let h=0;for(const[v,g]of b.entries())try{const k=o==="eth"?await d.sendTransaction({to:g,value:ce(P(c))}):await f.transfer(g,Ce(P(c),p));await k.wait(),w(`Fund ${v+1}/${b.length} to ${R(g)}: ${k.hash}`),h++}catch(k){w(`Fund ${v+1}/${b.length} to ${R(g)} failed: ${k.shortMessage||k.message}`)}t.textContent=`Funded ${h}/${b.length} wallet(s) with ${P(c)} ${o==="eth"?"ETH":"token"} each. Check log for hashes and failures.`,e&&h>0&&await eo()}async function st(e,t,n){const a=await yl(e,t,n);if(a.exists)return a;const r=await xl(e,n);return r.exists?r:{exists:!1,error:`No V2 pool (${a.error}) and no V3 pool (${r.error}).`}}async function yl(e,t,n){try{const a=new _(t,we,e),[r,o]=await Promise.all([a.WETH(),a.factory()]),i=await new _(o,ki,e).getPair(n,r);if(!i||i===he)return{exists:!1,error:"factory has no V2 pair for this token/WETH"};const c=new _(i,Si,e),[u,d]=await c.getReserves(),f=(await c.token0()).toLowerCase()===n.toLowerCase(),p=f?u:d,h=f?d:u;return p===0n||h===0n?{exists:!1,pairAddress:i,error:"V2 pair exists but has zero reserves"}:{exists:!0,version:"v2",pairAddress:i,wethReserve:Number(O(h)),tokenReserve:Number(X(p,18))}}catch(a){return{exists:!1,error:a.shortMessage||a.message}}}async function xl(e,t){try{const a=await zt(e).getDexConfig(0);if(!a.enabled||!a.factory||a.factory===he)return{exists:!1,error:"no V3 DEX config available"};const r=new _(a.factory,br,e),o=oe.router?await new _(oe.router,we,e).WETH():null;if(!o)return{exists:!1,error:"could not resolve WETH address"};const s=await r.getPool(t,o,a.poolFee);if(!s||s===he)return{exists:!1,error:"no V3 pool for this token/WETH at the known fee tier"};const i=new _(s,Pa,e),[c,u]=await Promise.all([i.liquidity(),i.token0()]);return c===0n?{exists:!1,poolAddress:s,error:"V3 pool exists but has zero liquidity"}:{exists:!0,version:"v3",poolAddress:s,wethAddress:o,swapRouter:a.swapRouter,poolFee:a.poolFee,isToken0:u.toLowerCase()===t.toLowerCase()}}catch(n){return{exists:!1,error:n.shortMessage||n.message}}}function Ke(e){return e.split(/\r?\n/).map(t=>t.trim()).filter(Boolean)}function vl(){const e=Math.max(1,Math.min(200,parseInt(l.mmGenerateCount.value)||5)),t=Array.from({length:e},()=>K.createRandom());l.mmWalletKeys.value=t.map(n=>n.privateKey).join(`
`),B.lastGenerated=t.map(n=>({address:n.address,privateKey:n.privateKey})),document.querySelector("#mmWalletResult").textContent=`Generated ${e} wallet(s) locally. Download the JSON to keep a copy, or start the bot with them now.`,w(`Market Maker Bot: generated ${e} fresh wallet(s) locally.`)}function wl(){const e=Ke(l.mmWalletKeys.value);if(e.length===0){document.querySelector("#mmWalletResult").textContent="Generate or paste wallet keys first.";return}let t;try{t=e.map(o=>{const s=new K(o);return{address:s.address,privateKey:s.privateKey}})}catch(o){document.querySelector("#mmWalletResult").textContent=`Invalid private key — ${o.message}`;return}const n=new Blob([JSON.stringify({generatedAt:new Date().toISOString(),wallets:t},null,2)],{type:"application/json"}),a=URL.createObjectURL(n),r=document.createElement("a");r.href=a,r.download="market-making-wallets.json",document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(a),document.querySelector("#mmWalletResult").textContent=`Downloaded market-making-wallets.json with ${t.length} wallet(s). Keep this file private — it contains raw private keys.`,w(`Market Maker Bot: downloaded market-making-wallets.json with ${t.length} wallet(s).`)}async function gl(e){var n;const t=(n=e.target.files)==null?void 0:n[0];if(t)try{const a=await t.text(),r=JSON.parse(a),o=Array.isArray(r)?r:r.wallets;if(!Array.isArray(o)||o.length===0)throw new Error("No wallets found in file.");const s=o.map(i=>i.privateKey||i.secretKey||i.key).filter(Boolean);if(s.length===0)throw new Error("File has no privateKey fields.");l.mmWalletKeys.value=s.join(`
`),document.querySelector("#mmWalletResult").textContent=`Imported ${s.length} wallet(s) from ${t.name}.`,w(`Market Maker Bot: imported ${s.length} wallet(s) from ${t.name}.`)}catch(a){document.querySelector("#mmWalletResult").textContent=`Import failed — ${a.message}`}finally{e.target.value=""}}function an(e){B.trades.unshift({time:Date.now(),...e}),B.trades.length>200&&(B.trades.length=200)}async function $l(){B.running?kl():await eo()}async function eo(){var f;const e=l.mmTokenAddress.value.trim()||((f=y.contract)==null?void 0:f.target);if(!Y(e||"")){w("Market Maker Bot: enter a valid token contract address.");return}const t=Ke(l.mmWalletKeys.value);if(t.length===0){w("Market Maker Bot: paste at least one wallet private key.");return}const n=te();let a;try{a=t.map(p=>new K(p,n))}catch(p){w(`Market Maker Bot: invalid private key — ${p.message}`);return}const r=Ke(l.mmReactiveKeys.value),o=r.length>0?r.map(p=>new K(p,n)):[],s=ke(),i=await st(n,s,e);if(!i.exists){w(`Market Maker Bot: no ${R(e)}/WETH pool found on router ${R(s)} — ${i.error||"add liquidity first (LP tab)."}`),document.querySelector("#mmWalletResult").textContent=`No pool found for this token on the configured router. ${i.error||"Add liquidity first (LP tab)."}`;return}i.version==="v3"?w(`Market Maker Bot: V3 pool found at ${R(i.poolAddress)} (fee ${i.poolFee}), no V2 pair exists — trading via V3 exactInputSingle.`):w(`Market Maker Bot: V2 pool found at ${R(i.pairAddress)} — ${P(i.wethReserve)} WETH / ${P(i.tokenReserve)} token reserves.`);const c=Math.max(1,parseInt(l.mmTxnsPerUnit.value)||2),b=(l.mmIntervalUnit.value==="per_second"?1e3:6e4)/c;B.config={tokenAddress:e,routerAddress:s,poolVersion:i.version,pairAddress:i.pairAddress,v3PoolAddress:i.poolAddress,v3SwapRouter:i.swapRouter,v3PoolFee:i.poolFee,v3WethAddress:i.wethAddress,v3IsToken0:i.isToken0,minBuyEth:parseFloat(l.mmMinBuy.value)||.001,maxBuyEth:parseFloat(l.mmMaxBuy.value)||.01,minSellPct:parseFloat(l.mmMinSellPct.value)||10,maxSellPct:parseFloat(l.mmMaxSellPct.value)||50,sellHardcap:parseFloat(l.mmSellHardcap.value)||0,buyWeight:Number(l.mmBuyWeight.value)||50,minIntervalMs:Math.floor(b*.7),maxIntervalMs:Math.floor(b*1.3),slippagePct:parseFloat(l.mmSlippage.value)||25,gasPriceGwei:parseFloat(l.mmGasPrice.value)||0,minReserveEth:parseFloat(l.mmMinReserve.value)||.005,reactiveEnabled:l.mmReactiveEnabled.checked,reactivePct:parseFloat(l.mmReactivePct.value)||50,reactiveMaxTokens:parseFloat(l.mmReactiveMaxTokens.value)||0},B.provider=n,B.wallets=a,B.reactiveWallets=o,B.balances={},B.trades=[],B.stats={startedAt:Date.now(),totalBuys:0,totalSells:0,reactiveSells:0,totalBuyVolumeEth:0,successfulTrades:0,failedTrades:0,cyclesCompleted:0,lastTradeAt:null,lastError:null},B.running=!0,w(`Market Maker Bot: started for ${R(e)} with ${a.length} wallet(s).`),At(),await to(),ao(),B.config.reactiveEnabled&&Cl(),B.uptimeTicker=setInterval(()=>{const p=document.querySelector('[data-tab-panel="mmBot"] [data-mm-uptime]');p&&(p.textContent=Vr(Date.now()-B.stats.startedAt))},1e3)}function kl(){B.running=!1,B.loopTimeout&&(clearTimeout(B.loopTimeout),B.loopTimeout=null),B.uptimeTicker&&(clearInterval(B.uptimeTicker),B.uptimeTicker=null),Rl(),w(`Market Maker Bot: stopped after ${B.stats.cyclesCompleted} cycle(s).`),At()}async function to(){const e=B.config,t=new _(e.tokenAddress,ue.abi,B.provider);let n=18;try{n=Number(await t.decimals())}catch{}const a={};await Promise.allSettled(B.wallets.map(async r=>{try{const[o,s]=await Promise.all([B.provider.getBalance(r.address),t.balanceOf(r.address)]);a[r.address]={eth:Number(O(o)),token:Number(X(s,n)),tokenDecimals:n}}catch{a[r.address]={eth:0,token:0,tokenDecimals:n}}})),B.balances=a}function Sl(){const e=B.config,t=[],n=[];for(const d of B.wallets){const b=B.balances[d.address];if(!b)continue;const f=e.minBuyEth+e.minReserveEth;b.eth>=f&&t.push(d),b.token>0&&n.push(d)}if(t.length===0&&n.length===0)return null;const a=Math.random()*100;let r;if(t.length===0?r="sell":n.length===0?r="buy":r=a<e.buyWeight?"buy":"sell",r==="buy"){const d=t[Math.floor(Math.random()*t.length)],b=B.balances[d.address],f=Math.min(e.maxBuyEth,b.eth-e.minReserveEth),p=e.minBuyEth+Math.random()*(e.maxBuyEth-e.minBuyEth),h=Math.round(Math.min(p,f)*1e6)/1e6;return h<e.minBuyEth?null:{action:"buy",wallet:d,amount:h}}n.sort((d,b)=>{var f,p;return(((f=B.balances[b.address])==null?void 0:f.token)||0)-(((p=B.balances[d.address])==null?void 0:p.token)||0)});const o=n[0],s=B.balances[o.address],i=e.minSellPct+Math.random()*(e.maxSellPct-e.minSellPct);let c=s.token*(i/100);e.sellHardcap>0&&(c=Math.min(c,e.sellHardcap));const u=Math.round(c*10**s.tokenDecimals)/10**s.tokenDecimals;return u<=0?null:{action:"sell",wallet:o,amount:u}}function Fe(e,t){const n=BigInt(Math.max(0,Math.round((100-(t||0))*100))),a=e*n/10000n;return a>0n?a:0n}async function xn(e,t,n,a){const o=await new _(e,we,a).getAmountsOut(n,t);return o[o.length-1]}async function $t(e,t,n,a){const r=new _(e,Pa,a),[o,s]=await Promise.all([r.slot0(),r.liquidity()]),i=2n**96n,c=10n**27n,u=o.sqrtPriceX96*c/i,d=s;if(d===0n)return 0n;if(t){const m=c*c/u+n*c/d,v=c*c/m;return d*(u-v)/c}const b=u+n*c/d,f=c*c/u,p=c*c/b;return d*(f-p)/c}async function El(e,t){const n=B.config;if(n.poolVersion==="v3")return Tl(e,t);const a=new _(n.routerAddress,we,e),r={value:ce(String(t))};n.gasPriceGwei>0&&(r.gasPrice=Ce(String(n.gasPriceGwei),"gwei"));const s=[await a.WETH(),n.tokenAddress],i=await xn(n.routerAddress,s,r.value,e.provider),c=Fe(i,n.slippagePct),u=await a.swapExactETHForTokensSupportingFeeOnTransferTokens(c,s,e.address,We("20"),r);return await u.wait(),u.hash}async function Tl(e,t){const n=B.config,a=new _(n.v3SwapRouter,[Re[0]],e),r={value:ce(String(t))};n.gasPriceGwei>0&&(r.gasPrice=Ce(String(n.gasPriceGwei),"gwei"));const o=await $t(n.v3PoolAddress,!n.v3IsToken0,r.value,e.provider),s=Fe(o,n.slippagePct),i={tokenIn:n.v3WethAddress,tokenOut:n.tokenAddress,fee:n.v3PoolFee,recipient:e.address,amountIn:r.value,amountOutMinimum:s,sqrtPriceLimitX96:0n},c=await a.exactInputSingle(i,r);return await c.wait(),c.hash}async function no(e,t,n){const a=B.config;if(a.poolVersion==="v3")return Bl(e,t,n);const r=new _(a.tokenAddress,ue.abi,e),o=new _(a.routerAddress,we,e),s=Ce(P(t),n);await r.allowance(e.address,a.routerAddress)<s&&await(await r.approve(a.routerAddress,s)).wait();const c={};a.gasPriceGwei>0&&(c.gasPrice=Ce(String(a.gasPriceGwei),"gwei"));const u=await o.WETH(),d=[a.tokenAddress,u],b=await xn(a.routerAddress,d,s,e.provider),f=Fe(b,a.slippagePct),p=await o.swapExactTokensForETHSupportingFeeOnTransferTokens(s,f,d,e.address,We("20"),c);return await p.wait(),p.hash}async function f0(e){return Number(O(await e.provider.getBalance(e.address)))}async function Bl(e,t,n){const a=B.config,r=new _(a.tokenAddress,ue.abi,e),o=new _(a.v3SwapRouter,[Re[0]],e),s=Ce(P(t),n);await r.allowance(e.address,a.v3SwapRouter)<s&&await(await r.approve(a.v3SwapRouter,s)).wait();const c={};a.gasPriceGwei>0&&(c.gasPrice=Ce(String(a.gasPriceGwei),"gwei"));const u=await $t(a.v3PoolAddress,a.v3IsToken0,s,e.provider),d=Fe(u,a.slippagePct),b={tokenIn:a.tokenAddress,tokenOut:a.v3WethAddress,fee:a.v3PoolFee,recipient:e.address,amountIn:s,amountOutMinimum:d,sqrtPriceLimitX96:0n},f=await o.exactInputSingle(b,c);await f.wait();const p=new _(a.v3WethAddress,Ia,e),h=await p.balanceOf(e.address);return h>0n&&await(await p.withdraw(h)).wait(),f.hash}async function ao(){var e;if(B.running){try{B.stats.cyclesCompleted%5===0&&await to();const t=Sl();if(!t){an({action:"skip",wallet:null,amount:0,unit:"",hash:null,status:"skipped",error:"No wallets with sufficient balance"}),B.stats.cyclesCompleted++,At(),p0();return}let n=null,a=null;try{if(t.action==="buy")n=await El(t.wallet,t.amount),B.stats.totalBuys++,B.stats.totalBuyVolumeEth+=t.amount,B.balances[t.wallet.address]&&(B.balances[t.wallet.address].eth=await f0(t.wallet));else{const r=((e=B.balances[t.wallet.address])==null?void 0:e.tokenDecimals)??18;n=await no(t.wallet,t.amount,r),B.stats.totalSells++,B.balances[t.wallet.address]&&(B.balances[t.wallet.address].token-=t.amount,B.balances[t.wallet.address].eth=await f0(t.wallet))}B.stats.successfulTrades++}catch(r){a=r.shortMessage||r.message,B.stats.failedTrades++,B.stats.lastError=a}an({action:t.action,wallet:t.wallet.address,amount:t.amount,unit:t.action==="buy"?"ETH":"tokens",hash:n,status:a?"failed":"success",error:a}),B.stats.lastTradeAt=Date.now(),B.stats.cyclesCompleted++,At()}catch(t){B.stats.lastError=t.message,B.stats.failedTrades++,an({action:"error",wallet:null,amount:0,unit:"",hash:null,status:"error",error:t.message}),At()}p0()}}function p0(){if(!B.running)return;const e=B.config,t=e.minIntervalMs+Math.random()*(e.maxIntervalMs-e.minIntervalMs);B.loopTimeout=setTimeout(()=>ao(),t)}function Cl(){const e=B.config,t=new _(e.tokenAddress,ue.abi,B.provider),n=new Set([...B.wallets.map(o=>o.address.toLowerCase()),...B.reactiveWallets.map(o=>o.address.toLowerCase())]),a=e.poolVersion==="v3"?e.v3SwapRouter:e.routerAddress;B.reactiveFilter=t.filters.Transfer();const r=async(o,s,i)=>{var h;if(!B.running||!B.config.reactiveEnabled||o.toLowerCase()!==a.toLowerCase()||n.has(s.toLowerCase()))return;const c=((h=Object.values(B.balances)[0])==null?void 0:h.tokenDecimals)??18,u=Number(X(i,c));let d=u*(e.reactivePct/100);if(e.reactiveMaxTokens>0&&(d=Math.min(d,e.reactiveMaxTokens)),d<=0)return;w(`Market Maker Bot: external buy detected (${P(u)} tokens). Triggering reactive sell.`);const f=[...B.reactiveWallets.length>0?B.reactiveWallets:B.wallets].sort((m,v)=>{var g,k;return(((g=B.balances[v.address])==null?void 0:g.token)||0)-(((k=B.balances[m.address])==null?void 0:k.token)||0)});let p=d;for(const m of f){if(p<=0)break;const v=B.balances[m.address];if(!v||v.token<=0)continue;const g=Math.min(v.token,p);try{const k=await no(m,g,v.tokenDecimals);v.token-=g,B.stats.reactiveSells++,B.stats.successfulTrades++,an({action:"reactive_sell",wallet:m.address,amount:g,unit:"tokens",hash:k,status:"success",error:null}),p-=g}catch(k){B.stats.failedTrades++,an({action:"reactive_sell",wallet:m.address,amount:g,unit:"tokens",hash:null,status:"failed",error:k.shortMessage||k.message})}}At()};B._reactiveHandler=r,t.on(B.reactiveFilter,r),B._reactiveToken=t,w("Market Maker Bot: reactive sell watcher started.")}function Rl(){if(B._reactiveToken&&B.reactiveFilter&&B._reactiveHandler)try{B._reactiveToken.off(B.reactiveFilter,B._reactiveHandler)}catch{}B._reactiveToken=null,B._reactiveHandler=null,B.reactiveFilter=null}const C={username:"",role:"",isSuperAdmin:!1,permissions:new Set,catalogue:{tabs:[],actions:[]},roles:[],users:[],canManageRoles:!1,canManageUsers:!1,projects:[],activeProjectId:"",canManageProjects:!1};function h0(e){return C.permissions.has(e)}function Al(e){return C.permissions.has(`tab.${e}`)}async function Ll(){try{const t=await(await fetch("/api/auth/session",{credentials:"same-origin"})).json();return t.authenticated?(C.username=t.username||"",C.role=t.role||"",C.isSuperAdmin=!!t.isSuperAdmin,C.permissions=new Set(t.permissions||[]),C.canManageRoles=C.permissions.has("roles.manage"),C.canManageUsers=C.permissions.has("users.manage"),!0):!1}catch{return!1}}function ve(e,t={}){const n={...t.headers||{}};return C.activeProjectId&&(n["X-Project-Id"]=C.activeProjectId),fetch(e,{...t,headers:n,credentials:"same-origin"})}async function Fa(){var e;try{const n=await(await fetch("/api/admin/projects",{credentials:"same-origin"})).json();C.projects=n.projects||[],C.canManageProjects=C.permissions.has("projects.manage"),C.projects.some(a=>a.id===C.activeProjectId)||(C.activeProjectId=((e=C.projects[0])==null?void 0:e.id)||""),ro(),_l()}catch{C.projects=[]}}function ro(){const e=C.projects.find(t=>t.id===C.activeProjectId);e&&(l.contractAddress&&e.config.tokenAddress&&(l.contractAddress.value=e.config.tokenAddress),l.rpcUrl&&e.config.rpcUrl&&(l.rpcUrl.value=e.config.rpcUrl),l.router&&e.config.router&&(l.router.value=e.config.router))}async function Yn(e){if(C.activeProjectId=e,ro(),typeof vt=="function")try{await vt(!1)}catch{}lt();const t=document.querySelector("#activeProjectSelect");t&&t.value!==C.activeProjectId&&(t.value=C.activeProjectId)}async function $e(e,t={}){const n=await fetch(e,{credentials:"same-origin",...t}),a=await n.json().catch(()=>({}));if(!n.ok)throw new Error(a.error||`Request failed (${n.status}).`);return a}async function Je(){if(C.canManageRoles||C.canManageUsers){const e=await $e("/api/admin/roles");C.catalogue={tabs:e.tabs||[],actions:e.actions||[]},C.roles=e.roles||[]}if(C.canManageUsers){const e=await $e("/api/admin/users");C.users=e.users||[]}C.canManageProjects&&await Fa(),Il(),Ml(),oo(),Pl()}function Pl(){const e=document.querySelector("#adminProjectsList"),t=document.querySelector("#adminAccessProject");if(!(!e&&!t)){if(e){e.innerHTML=C.projects.length===0?"No projects yet.":C.projects.map(n=>`
      ...
      </div>`).join("");for(const n of e.querySelectorAll("[data-admin-delete-project]"))n.addEventListener("click",async()=>{const a=n.dataset.adminDeleteProject,r=C.projects.find(o=>o.id===a);if(confirm(`Delete project "${(r==null?void 0:r.name)||a}"? Its wallet vault must already be empty.`))try{await $e(`/api/admin/projects?id=${encodeURIComponent(a)}`,{method:"DELETE"}),re("#adminProjectResult",`Deleted "${(r==null?void 0:r.name)||a}".`),await Je(),lt()}catch(o){re("#adminProjectResult",o.message)}})}t&&(t.innerHTML=C.projects.map(n=>`<option value="${n.id}">${q(n.name)}</option>`).join(""),Hn(t.value),t.addEventListener("change",()=>Hn(t.value)))}}async function Hn(e){const t=document.querySelector("#adminAccessList");if(!(!t||!e)){t.textContent="Loading access list...";try{const a=(await $e(`/api/admin/project-access?projectId=${encodeURIComponent(e)}`)).access||[];t.innerHTML=a.length===0?"No one has explicit access yet (super_admin always sees every project).":a.map(r=>`
      <div class="admin-user-row">
        <span>${q(r.username)}</span>
        <button type="button" data-admin-revoke="${q(r.username)}">Revoke</button>
      </div>`).join("");for(const r of t.querySelectorAll("[data-admin-revoke]"))r.addEventListener("click",async()=>{try{await $e(`/api/admin/project-access?projectId=${encodeURIComponent(e)}&username=${encodeURIComponent(r.dataset.adminRevoke)}`,{method:"DELETE"}),Hn(e)}catch(o){re("#adminProjectResult",o.message)}})}catch(n){t.textContent=n.message}}}function Il(){const e=document.querySelector("#adminUsersList");if(e){if(C.users.length===0){e.textContent="No users found.";return}e.innerHTML=C.users.map(t=>{const n=t.username.toLowerCase()===C.username.toLowerCase(),a=[...C.isSuperAdmin?["super_admin"]:[],...C.roles.map(r=>r.name)];return`
      <div class="admin-user-row">
      ...
      </div>`}).join("");for(const t of e.querySelectorAll("[data-admin-role-for]"))t.addEventListener("change",async()=>{const n=t.dataset.adminRoleFor;try{await $e("/api/admin/users",{method:"PATCH",headers:{"content-type":"application/json"},body:JSON.stringify({username:n,role:t.value})}),re("#adminUserResult",`${n} is now "${t.value}".`),await Je()}catch(a){re("#adminUserResult",a.message),await Je()}});for(const t of e.querySelectorAll("[data-admin-reset]"))t.addEventListener("click",async()=>{const n=t.dataset.adminReset,a=prompt(`New password for ${n} (min 8 characters):`);if(a)try{await $e("/api/admin/users",{method:"PATCH",headers:{"content-type":"application/json"},body:JSON.stringify({username:n,password:a})}),re("#adminUserResult",`Password reset for ${n}. Their existing sessions were signed out.`)}catch(r){re("#adminUserResult",r.message)}});for(const t of e.querySelectorAll("[data-admin-delete-user]"))t.addEventListener("click",async()=>{const n=t.dataset.adminDeleteUser;if(confirm(`Delete user "${n}"? This cannot be undone.`))try{await $e(`/api/admin/users?username=${encodeURIComponent(n)}`,{method:"DELETE"}),re("#adminUserResult",`Deleted ${n}.`),await Je()}catch(a){re("#adminUserResult",a.message)}})}}function Ml(){const e=document.querySelector("#adminNewRole");if(e){const n=[...C.isSuperAdmin?["super_admin"]:[],...C.roles.map(a=>a.name)];e.innerHTML=n.map(a=>`<option value="${q(a)}">${q(a)}</option>`).join("")}const t=document.querySelector("#adminRoleSelect");t&&(t.innerHTML='<option value="">— new role —</option>'+C.roles.map(n=>`<option value="${q(n.name)}">${q(n.name)}</option>`).join(""))}function oo(e=null){const t=document.querySelector("#adminPermissionGrid");if(!t)return;const n=new Set(e||[]),a=C.catalogue.tabs.map(o=>{const s=`tab.${o.id}`,i=!C.isSuperAdmin&&!h0(s);return`<label class="admin-perm${i?" locked":""}">
      <input type="checkbox" value="${q(s)}"${n.has(s)?" checked":""}${i?" disabled":""} />
      ${q(o.label)}
    </label>`}).join(""),r=C.catalogue.actions.map(o=>{const s=!C.isSuperAdmin&&!h0(o.id);return`<label class="admin-perm${o.danger?" danger":""}${s?" locked":""}">
    ...
    <div class="admin-perm-grid">${r}</div>`}function Dl(){return[...document.querySelectorAll("#adminPermissionGrid input[type=checkbox]:checked")].map(e=>e.value)}function re(e,t){const n=document.querySelector(e);n&&(n.textContent=t)}function Fl(){var t,n,a,r,o;const e=document.querySelector("#adminRoleSelect");e&&e.addEventListener("change",()=>{const s=C.roles.find(i=>i.name===e.value);l.adminRoleName.value=s?s.name:"",l.adminRoleDescription.value=s?s.description:"",oo(s?s.permissions:[])}),(t=document.querySelector("#adminSaveRole"))==null||t.addEventListener("click",async()=>{try{await $e("/api/admin/roles",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({name:l.adminRoleName.value.trim(),description:l.adminRoleDescription.value.trim(),permissions:Dl()})}),re("#adminRoleResult",`Saved role "${l.adminRoleName.value.trim()}".`),await Je()}catch(s){re("#adminRoleResult",s.message)}}),(n=document.querySelector("#adminDeleteRole"))==null||n.addEventListener("click",async()=>{const s=l.adminRoleName.value.trim();if(!s)return re("#adminRoleResult","Pick a role to delete.");if(confirm(`Delete role "${s}"?`))try{await $e(`/api/admin/roles?name=${encodeURIComponent(s)}`,{method:"DELETE"}),re("#adminRoleResult",`Deleted role "${s}".`),await Je()}catch(i){re("#adminRoleResult",i.message)}}),(a=document.querySelector("#adminCreateUser"))==null||a.addEventListener("click",async()=>{try{await $e("/api/admin/users",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({username:l.adminNewUsername.value.trim(),password:l.adminNewPassword.value,role:document.querySelector("#adminNewRole").value})}),re("#adminUserResult",`Created ${l.adminNewUsername.value.trim()}.`),l.adminNewUsername.value="",l.adminNewPassword.value="",await Je()}catch(s){re("#adminUserResult",s.message)}}),(r=document.querySelector("#adminCreateProject"))==null||r.addEventListener("click",async()=>{try{const s=await $e("/api/admin/projects",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({name:l.adminProjectName.value.trim(),tokenAddress:l.adminProjectTokenAddress.value.trim(),rpcUrl:l.adminProjectRpcUrl.value.trim(),router:l.adminProjectRouter.value.trim()})});re("#adminProjectResult",`Created "${s.project.name}".`),l.adminProjectName.value="",l.adminProjectTokenAddress.value="",l.adminProjectRpcUrl.value="",l.adminProjectRouter.value="",await Je(),lt()}catch(s){re("#adminProjectResult",s.message)}}),(o=document.querySelector("#adminGrantAccess"))==null||o.addEventListener("click",async()=>{var c;const s=(c=document.querySelector("#adminAccessProject"))==null?void 0:c.value,i=l.adminAccessUsername.value.trim();if(!s||!i)return re("#adminProjectResult","Pick a project and enter a username.");try{await $e(`/api/admin/project-access?projectId=${encodeURIComponent(s)}`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({username:i})}),l.adminAccessUsername.value="",Hn(s),re("#adminProjectResult",`Granted ${i} access.`)}catch(u){re("#adminProjectResult",u.message)}}),(C.canManageRoles||C.canManageUsers||C.canManageProjects)&&Je().catch(s=>{re("#adminUserResult",s.message),re("#adminRoleResult",s.message),re("#adminProjectResult",s.message)})}function Wl(){const e=$i.filter(t=>Al(t.id));return(C.canManageUsers||C.canManageRoles)&&e.push({id:"admin",label:"Users & Roles",icon:"🛡️"}),e.length>0&&!e.some(t=>t.id===y.activeFunctionTab)&&(y.activeFunctionTab=e[0].id),e}function q(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ol(){return`
    <h2>Users, Roles &amp; Projects</h2>
    <p class="hint">
      Signed in as <strong>${q(C.username)}</strong> (${q(C.role)}).
  ...
  `}function so(){return C.projects.length===0?'<span class="project-switcher project-switcher-empty">No projects yet</span>':`<label class="project-switcher">
    Project
    <select id="activeProjectSelect">
      ${C.projects.map(e=>`<option value="${e.id}"${e.id===C.activeProjectId?" selected":""}>${q(e.name)}</option>`).join("")}
    </select>
  </label>`}function _l(){var t;const e=document.querySelector("#projectSwitcherSlot");e&&(e.innerHTML=so(),(t=document.querySelector("#activeProjectSelect"))==null||t.addEventListener("change",n=>{Yn(n.target.value)}))}function Nl(){var e,t,n,a,r,o,s,i,c,u,d,b,f,p,h,m,v,g,k,T,S,E,L,M,D,I,H;vi.innerHTML=`
    <main>
      <section class="hero">
        <div>
...
0x_private_key`)}</label>
        ...
        <div class="tab-panel ${y.activeFunctionTab==="lunch"?"active":""}" data-tab-panel="lunch">
          ...
          <h2 class="section-gap">Contract</h2>
          <div class="grid two">
            <label>Launch proxy <input id="lunchLaunchContract" readonly value="${U.launchContract}" /></label>
            <label>7702 coordinator <input id="lunch7702Coordinator" readonly value="${U.coordinator7702}" /></label>
            <label>7702 buyer delegate <input id="lunch7702Delegate" readonly value="${U.delegate7702}" /></label>
            <label>Coordinator owner <input id="lunchAtomicOwner" readonly placeholder="Load status" /></label>
            <label>Implementation <input id="lunchImplementation" readonly value="${U.implementation}" /></label>
            <label>Launch fee <input id="lunchLaunchFee" readonly placeholder="-" /></label>
            <label>Router for later buys ${x("lunchRouter",U.router)}</label>
        ...
        <div class="tab-panel ${y.activeFunctionTab==="lunchBurst"?"active":""}" data-tab-panel="lunchBurst">
          ...
          <h2 class="section-gap">Contract</h2>
          <div class="grid two">
            <label>Launch proxy <input id="lunchBurstLaunchContract" readonly value="${U.launchContract}" /></label>
            <label>Implementation <input id="lunchBurstImplementation" readonly value="${U.implementation}" /></label>
            <label>Launch fee <input id="lunchBurstLaunchFee" readonly placeholder="-" /></label>
            <label>Router ${x("lunchBurstRouter",U.router)}</label>
        ...
        <div class="tab-panel ${y.activeFunctionTab==="doppler"?"active":""}" data-tab-panel="doppler">
          ...
          <div class="grid two">
            ...
            <label>Atomic executor <input id="dopplerExecutorAddress" readonly value="${j.atomicExecutor}" placeholder="Deploy DopplerAtomicExecutor and set the address" /></label>
            <label>Airlock <input readonly value="${j.airlock}" /></label>
            <label>Universal Router <input readonly value="${j.universalRouter}" /></label>
            <label>Token factory <input readonly value="${j.tokenFactory}" /></label>
            <label>Governance factory <input readonly value="${j.governanceFactory}" /></label>
            <label>Pool initializer / hooks <input readonly value="${j.poolInitializer}" /></label>
            <label>Liquidity migrator <input readonly value="${j.liquidityMigrator}" /></label>
            <label>Numeraire <input readonly value="${j.numeraire}" /></label>
        ...
        ${C.canManageUsers||C.canManageRoles?`
  ...
  `;for(const V of["rpcUrl","privateKey","tokenName","tokenSymbol","router","taxWallet","ecosystemWallet","bel","contractAddress","deployGasLimit","buyTokenAddress","buyEthAmount","buyMinTokens","buyRecipient","buyDeadline","buyerPrivateKeys","sellMinEth","sellRecipient","sellDeadline","sellerPrivateKeys","launchEthAmount","launchLpRecipient","lpTokenAmount","lpEthAmount","lpMinToken","lpMinEth","lpRecipient","lpDeadline","removePair","removeLpAmount","removeMinToken","removeMinEth","removeRecipient","removeDeadline","burnAmount","generatedAccounts","sendTo0","sendAmount0","sendTo1","sendAmount1","sendTo2","sendAmount2","sendTo3","sendAmount3","sendTo4","sendAmount4","sweepRecipient","sweepBuffer","sweepPrivateKeys","ponsCurrentBlock","ponsPrimaryWallet","ponsPrimaryBalance","ponsLaunchContract","ponsLaunchFee","ponsRouter","ponsFactory","ponsPositionManager","ponsPairToken","ponsLaunchConfigId","ponsDexId","ponsTokenName","ponsTokenSymbol","ponsLogo","ponsDescription","ponsTwitter","ponsTelegram","ponsDiscord","ponsWebsite","ponsFarcaster","ponsFeeWallet","ponsSalt","ponsSlippage","ponsOwner","ponsLaunchEnabledStatus","ponsIsOwner","ponsWhitelistAddress","ponsIsWhitelisted",...Array.from({length:1},(F,$)=>[`ponsBuyerEnabled${$}`,`ponsBuyerAddress${$}`,`ponsBuyerAmount${$}`,`ponsBuyerMinOut${$}`,`ponsBuyerBalance${$}`,`ponsBuyerGas${$}`,`ponsBuyerStatus${$}`,`ponsBuyerHash${$}`,`ponsBuyerReceived${$}`]).flat(),...Array.from({length:5},(F,$)=>[`ponsFastLaneBuyerEnabled${$}`,`ponsFastLaneBuyerKey${$}`,`ponsFastLaneBuyerAddress${$}`,`ponsFastLaneBuyerAmount${$}`,`ponsFastLaneBuyerMinOut${$}`,`ponsFastLaneBuyerBalance${$}`,`ponsFastLaneBuyerGas${$}`,`ponsFastLaneBuyerStatus${$}`,`ponsFastLaneBuyerHash${$}`,`ponsFastLaneBuyerReceived${$}`]).flat(),...et.flatMap(({prefix:F})=>Array.from({length:Ue},($,W)=>[`${F}BuyerEnabled${W}`,`${F}BuyerKey${W}`,`${F}BuyerAddress${W}`,`${F}BuyerAmount${W}`,`${F}BuyerMinOut${W}`,`${F}BuyerBalance${W}`,`${F}BuyerGas${W}`,`${F}BuyerStatus${W}`,`${F}BuyerHash${W}`,`${F}BuyerReceived${W}`]).flat()),"lunchCurrentBlock","lunchPrimaryWallet","lunchPrimaryBalance","lunchLaunchContract","lunch7702Coordinator","lunch7702Delegate","lunchAtomicOwner","lunchImplementation","lunchLaunchFee","lunchRouter","lunchFactory","lunchNpm","lunchXToken","lunchFeeLocker","lunchEnforcedSupply","lunchTickMagnitude","lunchTokenName","lunchTokenSymbol","lunchTotalSupply","lunchFeeTier","lunchImage","lunchBanner","lunchDescription","lunchWebsite","lunchTwitter","lunchTelegram","lunchSalt","lunchDeadline",...Array.from({length:5},(F,$)=>[`lunchBuyerEnabled${$}`,`lunchBuyerKey${$}`,`lunchBuyerAddress${$}`,`lunchBuyerAmount${$}`,`lunchBuyerMinOut${$}`,`lunchBuyerBalance${$}`,`lunchBuyerGas${$}`,`lunchBuyerStatus${$}`,`lunchBuyerHash${$}`,`lunchBuyerReceived${$}`]).flat(),"lunchBurstCurrentBlock","lunchBurstPrimaryWallet","lunchBurstPrimaryBalance","lunchBurstLaunchContract","lunchBurstImplementation","lunchBurstLaunchFee","lunchBurstRouter","lunchBurstFactory","lunchBurstNpm","lunchBurstXToken","lunchBurstEnforcedSupply","lunchBurstTokenName","lunchBurstTokenSymbol","lunchBurstTotalSupply","lunchBurstFeeTier","lunchBurstDevBuyEth","lunchBurstSalt","lunchBurstImage","lunchBurstBanner","lunchBurstDescription","lunchBurstWebsite","lunchBurstTwitter","lunchBurstTelegram",...Array.from({length:25},(F,$)=>[`lunchBurstBuyerEnabled${$}`,`lunchBurstBuyerKey${$}`,`lunchBurstBuyerAddress${$}`,`lunchBurstBuyerAmount${$}`,`lunchBurstBuyerMinOut${$}`,`lunchBurstBuyerBalance${$}`,`lunchBurstBuyerGas${$}`,`lunchBurstBuyerStatus${$}`,`lunchBurstBuyerHash${$}`,`lunchBurstBuyerReceived${$}`]).flat(),"lunchComboCurrentBlock","lunchComboPrimaryWallet","lunchComboPrimaryBalance","lunchComboTokenName","lunchComboTokenSymbol","lunchComboTotalSupply","lunchComboFeeTier","lunchComboImage","lunchComboBanner","lunchComboDescription","lunchComboWebsite","lunchComboTwitter","lunchComboTelegram","lunchComboSalt","lunchComboDeadline","lunchComboDevBuyEth",...Array.from({length:5},(F,$)=>[`lunchComboBuyerEnabled${$}`,`lunchComboBuyerKey${$}`,`lunchComboBuyerAddress${$}`,`lunchComboBuyerAmount${$}`,`lunchComboBuyerMinOut${$}`,`lunchComboBuyerBalance${$}`,`lunchComboBuyerGas${$}`,`lunchComboBuyerStatus${$}`,`lunchComboBuyerHash${$}`,`lunchComboBuyerReceived${$}`]).flat(),...Array.from({length:25},(F,$)=>[`lunchComboBurstBuyerEnabled${$}`,`lunchComboBurstBuyerKey${$}`,`lunchComboBurstBuyerAddress${$}`,`lunchComboBurstBuyerAmount${$}`,`lunchComboBurstBuyerMinOut${$}`,`lunchComboBurstBuyerBalance${$}`,`lunchComboBurstBuyerGas${$}`,`lunchComboBurstBuyerStatus${$}`,`lunchComboBurstBuyerHash${$}`,`lunchComboBurstBuyerReceived${$}`]).flat(),"dopplerPrimaryWallet","dopplerPrimaryBalance","dopplerTokenName","dopplerTokenSymbol","dopplerInitialSupply","dopplerNumTokensToSell","dopplerIntegrator","dopplerSalt","dopplerNumeraireIsNative","dopplerDeadline","dopplerTokenFactoryData","dopplerGovernanceFactoryData","dopplerPoolInitializerData","dopplerLiquidityMigratorData",...Array.from({length:5},(F,$)=>[`dopplerBuyerEnabled${$}`,`dopplerBuyerAddress${$}`,`dopplerBuyerAmount${$}`,`dopplerBuyerMinOut${$}`,`dopplerBuyerGas${$}`,`dopplerBuyerStatus${$}`,`dopplerBuyerReceived${$}`]).flat(),"dopplerBurstPrimaryWallet","dopplerBurstPrimaryBalance","dopplerBurstTokenName","dopplerBurstTokenSymbol","dopplerBurstInitialSupply","dopplerBurstNumTokensToSell","dopplerBurstIntegrator","dopplerBurstSalt","dopplerBurstNumeraireIsNative","dopplerBurstTokenFactoryData","dopplerBurstGovernanceFactoryData","dopplerBurstPoolInitializerData","dopplerBurstLiquidityMigratorData",...Array.from({length:25},(F,$)=>[`dopplerBurstBuyerEnabled${$}`,`dopplerBurstBuyerKey${$}`,`dopplerBurstBuyerAddress${$}`,`dopplerBurstBuyerAmount${$}`,`dopplerBurstBuyerMinOut${$}`,`dopplerBurstBuyerBalance${$}`,`dopplerBurstBuyerGas${$}`,`dopplerBurstBuyerStatus${$}`,`dopplerBurstBuyerHash${$}`,`dopplerBurstBuyerReceived${$}`]).flat(),"verifyAddress","verifyContractName","verifyCompiler","verifyConstructorArgs","verifyGuid",...Gr,...Xr,...Jr,"multiBurstTokenAddress","multiBurstSlippage",...Array.from({length:25},(F,$)=>[`multiBurstBuyerEnabled${$}`,`multiBurstBuyerKey${$}`,`multiBurstBuyerAddress${$}`,`multiBurstBuyerAmount${$}`,`multiBurstBuyerBalance${$}`,`multiBurstBuyerStatus${$}`,`multiBurstBuyerHash${$}`,`multiBurstBuyerReceived${$}`]).flat(),"washTokenAddress","washSlippage","washSellKey","washSellAmount","washBuyKey","washRelayCount","washRelayDelayRange","washRelayVariancePct","washRelayGasReserve","washUseCrossChain","washSolanaRpcUrl","washSolanaGasReserve","washBatchSellKeys","washBatchBuyKeys","washBatchRelayCount","washBatchDelayRange","washBatchVariancePct","washBatchGasReserve","washBatchUseCrossChain","washBatchSolanaRpcUrl","washBatchSolanaGasReserve","pwponsCurrentBlock","pwponsPrimaryWallet","pwponsPrimaryBalance","pwponsLaunchContract","pwponsLaunchFee","pwponsRouter","pwponsFactory","pwponsPositionManager","pwponsPairToken","pwponsLaunchConfigId","pwponsDexId","pwponsTokenName","pwponsTokenSymbol","pwponsLogo","pwponsDescription","pwponsTwitter","pwponsTelegram","pwponsDiscord","pwponsWebsite","pwponsFarcaster","pwponsFeeWallet","pwponsSalt","pwponsSlippage","pwponsOwner","pwponsLaunchEnabledStatus","pwponsIsOwner","pwponsWhitelistAddress","pwponsIsWhitelisted",...Array.from({length:1},(F,$)=>[`pwponsBuyerEnabled${$}`,`pwponsBuyerAddress${$}`,`pwponsBuyerAmount${$}`,`pwponsBuyerMinOut${$}`,`pwponsBuyerBalance${$}`,`pwponsBuyerGas${$}`,`pwponsBuyerStatus${$}`,`pwponsBuyerHash${$}`,`pwponsBuyerReceived${$}`]).flat(),...Array.from({length:5},(F,$)=>[`pwponsFastLaneBuyerEnabled${$}`,`pwponsFastLaneBuyerKey${$}`,`pwponsFastLaneBuyerAddress${$}`,`pwponsFastLaneBuyerAmount${$}`,`pwponsFastLaneBuyerMinOut${$}`,`pwponsFastLaneBuyerBalance${$}`,`pwponsFastLaneBuyerGas${$}`,`pwponsFastLaneBuyerStatus${$}`,`pwponsFastLaneBuyerHash${$}`,`pwponsFastLaneBuyerReceived${$}`]).flat(),...et.flatMap(({prefix:F})=>Array.from({length:Ue},($,W)=>[`pw${F}BuyerEnabled${W}`,`pw${F}BuyerKey${W}`,`pw${F}BuyerAddress${W}`,`pw${F}BuyerAmount${W}`,`pw${F}BuyerMinOut${W}`,`pw${F}BuyerBalance${W}`,`pw${F}BuyerGas${W}`,`pw${F}BuyerStatus${W}`,`pw${F}BuyerHash${W}`,`pw${F}BuyerReceived${W}`]).flat()),"pwwashTokenAddress","pwwashSlippage","pwwashBatchSellKeys","pwwashBatchBuyKeys","pwwashBatchRelayCount","pwwashBatchDelayRange","pwwashBatchVariancePct","pwwashBatchGasReserve","pwwashBatchUseCrossChain","pwwashBatchSolanaRpcUrl","pwwashBatchSolanaGasReserve","pwponsWashStartDelay","ponsAllThenWash","ponsAllWashStartDelay","ponsAllWashSlippage","ponsAllWashRelayCount","ponsAllWashDelayRange","ponsAllWashVariancePct","ponsAllWashGasReserve","ponsAllWashUseCrossChain","ponsAllWashSolanaGasReserve","launchPlanBudget","launchPlanWalletCount","adminNewUsername","adminNewPassword","adminRoleName","adminRoleDescription","adminProjectName","adminProjectTokenAddress","adminProjectRpcUrl","adminProjectRouter","adminAccessUsername"])l[V]=document.querySelector(`#${V}`);l.tokenName.value="Hood Research Departmen",l.tokenSymbol.value="HRD",l.rpcUrl.value="/rpc",l.router.value=oe.router,l.buyMinTokens.value="0",l.buyDeadline.value="20",l.sellMinEth.value="0",l.sellDeadline.value="20",l.lpMinToken.value="0",l.lpMinEth.value="0",l.lpDeadline.value="20",l.removeMinToken.value="0",l.removeMinEth.value="0",l.removeDeadline.value="20",l.sweepBuffer.value="0.00001",l.ponsLaunchConfigId.value="0",l.ponsDexId.value="0",l.ponsSlippage.value="5",l.ponsBuyerEnabled0.checked=!0,l.pwponsLaunchConfigId.value="0",l.pwponsDexId.value="0",l.pwponsSlippage.value="5",l.pwponsBuyerEnabled0.checked=!0,l.lunchRouter.value=U.router,l.lunchTotalSupply.value="1000000000",l.lunchFeeTier.value="10000",l.lunchDeadline.value="5",l.lunchBuyerEnabled0.checked=!0,l.lunchBurstRouter.value=U.router,l.lunchBurstTotalSupply.value="1000000000",l.lunchBurstFeeTier.value="10000",l.lunchBurstDevBuyEth.value="0",l.lunchComboTotalSupply.value="1000000000",l.lunchComboFeeTier.value="10000",l.lunchComboDeadline.value="5",l.lunchComboDevBuyEth.value="0",l.lunchComboBuyerEnabled0.checked=!0,l.launchPlanBudget.value="6900",l.launchPlanWalletCount.value="100",l.verifyContractName.value=dt.contractName,l.verifyCompiler.value=dt.compilerVersion,document.querySelector("#signOutLink").addEventListener("click",ql),Fl(),(e=document.querySelector("#activeProjectSelect"))==null||e.addEventListener("change",V=>{Yn(V.target.value)}),document.querySelector("#connectMetaMask").addEventListener("click",Hl),document.querySelector("#addRobinhood").addEventListener("click",Ye),document.querySelector("#connect").addEventListener("click",jl);for(const V of document.querySelectorAll("[data-tab]"))V.addEventListener("click",ic);document.querySelector("#deploy").addEventListener("click",lc),document.querySelector("#diagnoseDeploy").addEventListener("click",bc),document.querySelector("#verifyLatestDeploy").addEventListener("click",$0),document.querySelector("#attach").addEventListener("click",co),document.querySelector("#buyAttachToken").addEventListener("click",fc),document.querySelector("#buyConnected").addEventListener("click",mc),document.querySelector("#buyBatch").addEventListener("click",yc),document.querySelector("#sellConnected").addEventListener("click",xc),document.querySelector("#sellBatch").addEventListener("click",vc),document.querySelector("#launchInitialLp").addEventListener("click",wc),document.querySelector("#addLp").addEventListener("click",gc),document.querySelector("#removeLp").addEventListener("click",$c),document.querySelector("#burnTokens").addEventListener("click",kc),document.querySelector("#generateAccounts").addEventListener("click",Sc),document.querySelector("#copyAccounts").addEventListener("click",Ec),document.querySelector("#loadAccountsToMultisend").addEventListener("click",Tc),document.querySelector("#sendEthBatch").addEventListener("click",Bc),document.querySelector("#previewSweep").addEventListener("click",Rc),document.querySelector("#sweepConnected").addEventListener("click",Cc),document.querySelector("#sweepBatch").addEventListener("click",Ac),document.querySelector("#ponsSwitchNetwork").addEventListener("click",Ye),document.querySelector("#ponsLoadStatus").addEventListener("click",()=>x0("")),document.querySelector("#ponsValidateAll").addEventListener("click",()=>ga("")),document.querySelector("#ponsExecuteAll").addEventListener("click",()=>g0("")),document.querySelector("#ponsCheckWhitelist").addEventListener("click",Lc),document.querySelector("#ponsEnableLaunch").addEventListener("click",()=>v0(!0)),document.querySelector("#ponsDisableLaunch").addEventListener("click",()=>v0(!1)),document.querySelector("#ponsWhitelistAdd").addEventListener("click",()=>w0(!0)),document.querySelector("#ponsWhitelistRemove").addEventListener("click",()=>w0(!1)),document.querySelector("#multiBurstCheckPool").addEventListener("click",Hc),document.querySelector("#multiBurstExecute").addEventListener("click",jc),(t=document.querySelector("#washCheckPool"))==null||t.addEventListener("click",Uc),(n=document.querySelector("#washRunSequence"))==null||n.addEventListener("click",zc),(a=document.querySelector("#washRunSequenceCrossChain"))==null||a.addEventListener("click",Xc),(r=document.querySelector("#washBatchRun"))==null||r.addEventListener("click",()=>Un()),document.querySelector("#lunchSwitchNetwork").addEventListener("click",Ye),document.querySelector("#lunchLoadStatus").addEventListener("click",vo),document.querySelector("#lunchReview").addEventListener("click",Na),document.querySelector("#lunchExecute").addEventListener("click",qa),document.querySelector("#lunchBurstSwitchNetwork").addEventListener("click",Ye),document.querySelector("#lunchBurstLoadStatus").addEventListener("click",To),document.querySelector("#lunchBurstReview").addEventListener("click",Bo),document.querySelector("#lunchBurstExecute").addEventListener("click",Co),document.querySelector("#lunchComboModeAtomic").addEventListener("change",Rn),document.querySelector("#lunchComboModeBurst").addEventListener("change",Rn),document.querySelector("#lunchComboModeChained").addEventListener("change",Rn),document.querySelector("#lunchComboSwitchNetwork").addEventListener("click",Ye),document.querySelector("#lunchComboLoadStatus").addEventListener("click",fd),document.querySelector("#lunchComboAtomicReview").addEventListener("click",pd),document.querySelector("#lunchComboAtomicExecute").addEventListener("click",hd),document.querySelector("#lunchComboBurstReview").addEventListener("click",md),document.querySelector("#lunchComboBurstExecute").addEventListener("click",yd),document.querySelector("#lunchComboChainedReview").addEventListener("click",xd),document.querySelector("#lunchComboChainedExecute").addEventListener("click",vd),Rn(),document.querySelector("#dopplerSwitchNetwork").addEventListener("click",Ye),document.querySelector("#dopplerLoadStatus").addEventListener("click",od),document.querySelector("#dopplerReview").addEventListener("click",sd),document.querySelector("#dopplerExecute").addEventListener("click",id),document.querySelector("#dopplerBurstSwitchNetwork").addEventListener("click",Ye),document.querySelector("#dopplerBurstLoadStatus").addEventListener("click",cd),document.querySelector("#dopplerBurstReview").addEventListener("click",ud),document.querySelector("#dopplerBurstExecute").addEventListener("click",bd),document.querySelector("#verifyContract").addEventListener("click",$0),document.querySelector("#checkVerifyStatus").addEventListener("click",Ed),document.querySelector("#openBlockscout").addEventListener("click",Td),document.querySelector("#launchPlanCalculate").addEventListener("click",Tr),document.querySelector("#launchPlanReset").addEventListener("click",Gi);for(const V of document.querySelectorAll("[data-call]"))V.addEventListener("click",hc);Qr(),Ir(),Rr(),Yr(),Zr(),Wi(),(o=document.querySelector("#ponsUseDevWallet"))==null||o.addEventListener("click",Vl),(s=document.querySelector("#ponsFillBundleWallets"))==null||s.addEventListener("click",Gl),(i=document.querySelector("#pwponsWashConnectDev"))==null||i.addEventListener("click",Xl),(c=document.querySelector("#pwponsWashFillBundle"))==null||c.addEventListener("click",y0),(u=document.querySelector("#pwponsWashFillWashBuy"))==null||u.addEventListener("click",Yl),(d=document.querySelector("#pwponsWashValidate"))==null||d.addEventListener("click",Jl),(b=document.querySelector("#pwponsWashStart"))==null||b.addEventListener("click",Zl),(f=document.querySelector("#pwponsSwitchNetwork"))==null||f.addEventListener("click",Ye),(p=document.querySelector("#pwponsLoadStatus"))==null||p.addEventListener("click",()=>x0("pw")),(h=document.querySelector("#pwponsValidateAll"))==null||h.addEventListener("click",()=>ga("pw")),(m=document.querySelector("#pwponsExecuteAll"))==null||m.addEventListener("click",()=>g0("pw")),(v=document.querySelector("#pwponsUseDevWallet"))==null||v.addEventListener("click",()=>kt("pwponsWalletsTabResult","Pons + Wash","pwponsDevWalletSelect")),(g=document.querySelector("#pwponsFillBundleWallets"))==null||g.addEventListener("click",y0),(k=document.querySelector("#pwwashBatchRun"))==null||k.addEventListener("click",()=>Un("#pwwashBatchResult")),(T=document.querySelector("#lunchUseDevWallet"))==null||T.addEventListener("click",Ql),(S=document.querySelector("#lunchFillBundleWallets"))==null||S.addEventListener("click",ec),(E=document.querySelector("#lunchBurstUseDevWallet"))==null||E.addEventListener("click",tc),(L=document.querySelector("#lunchBurstFillBundleWallets"))==null||L.addEventListener("click",nc),(M=document.querySelector("#lunchComboUseDevWallet"))==null||M.addEventListener("click",ac),(D=document.querySelector("#lunchComboFillBundleWallets"))==null||D.addEventListener("click",rc),(I=document.querySelector("#dopplerUseDevWallet"))==null||I.addEventListener("click",oc),(H=document.querySelector("#dopplerFillBundleWallets"))==null||H.addEventListener("click",sc),lt(),Vt()}function m0(e){const t=e.stateMutability==="payable";return`
...
${t.textContent}`}function Vt(){const e=document.querySelector("#status");e.textContent=y.signer?`Connected ${R(y.address)}${y.walletMode?` via ${y.walletMode}`:""}${y.contract?` | Contract ${R(y.contract.target)}`:""}`:"Not connected"}async function ql(e){e.preventDefault();try{await fetch("/api/auth/logout",{method:"POST",credentials:"same-origin"})}catch{}window.location.href="/login.html"}async function Hl(){if(!window.ethereum){w("MetaMask was not detected in this browser.");return}y.provider=new In(window.ethereum),await y.provider.send("eth_requestAccounts",[]),y.signer=await y.provider.getSigner(),y.address=await y.signer.getAddress(),y.walletMode="MetaMask";const e=await y.provider.getNetwork();w(`Connected MetaMask ${y.address} on chain ${e.chainId}`),e.chainId!==BigInt(oe.chainId)&&w('MetaMask is not on Robinhood Chain. Click "Add/Switch Robinhood Chain" or deploy will switch before sending.'),Vt()}async function Ye(){if(!window.ethereum){w("MetaMask was not detected in this browser.");return}try{await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:oe.chainIdHex}]}),w("MetaMask switched to Robinhood Chain.")}catch(e){if(e.code!==4902){w(`Switch failed: ${e.message}`);return}await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:oe.chainIdHex,chainName:oe.chainName,rpcUrls:[oe.rpcUrl],nativeCurrency:{name:oe.currencySymbol,symbol:oe.currencySymbol,decimals:18},blockExplorerUrls:[oe.blockExplorerUrl]}]}),w("Robinhood Chain was added to MetaMask.")}}async function jl(){y.provider=te(),y.signer=new K(l.privateKey.value.trim(),y.provider),y.address=await y.signer.getAddress(),y.walletMode="RPC";const e=await y.provider.getBalance(y.address);w(`Connected ${y.address} with ${O(e)} native balance`),Vt()}async function vn(e){if(!C.activeProjectId)throw new Error("Select a project first (top of the page).");const t=await ve(`/api/wallets?chain=evm&category=${e}&reveal=1`),n=await t.json();if(!t.ok)throw new Error(n.error||"Failed to load wallets.");return n.wallets}async function Ul(e){if(!C.activeProjectId)return[];const t=await ve(`/api/wallets?chain=evm&category=${e}`),n=await t.json();return t.ok?n.wallets:[]}async function Kl(e){const t=document.querySelector(`#${e}`);if(!t)return;const n=t.value,a=await Ul("dev");if(a.length===0){t.innerHTML='<option value="">No Dev wallets saved</option>';return}t.innerHTML=a.map((r,o)=>`<option value="${r.address}">${R(r.address)}${r.label?` — ${q(r.label)}`:""}${o===0?" (newest)":""}</option>`).join(""),a.some(r=>r.address===n)&&(t.value=n)}async function kt(e,t,n){const a=document.querySelector(`#${e}`);try{const r=document.querySelector(`#${n}`),o=r==null?void 0:r.value;if(!o)throw new Error("No Dev wallet saved for this project yet — generate one in the Wallets tab first.");a.textContent=`Loading Dev wallet ${R(o)} from the vault...`;const i=(await vn("dev")).find(u=>u.address.toLowerCase()===o.toLowerCase());if(!i)throw new Error(`Selected Dev wallet ${R(o)} was not found — it may have been deleted. Refresh the dropdown.`);y.provider=te(),y.signer=new K(i.privateKey,y.provider),y.address=await y.signer.getAddress(),y.walletMode="RPC";const c=await y.provider.getBalance(y.address);a.textContent=`Connected Dev wallet ${R(y.address)} (${P(Number(O(c)))} ETH) as the launch signer.`,w(`${t}: connected Dev wallet ${y.address} from the vault as signer.`),Vt()}catch(r){a.textContent=A(r)}}async function Gt(e,t,n,a){const r=document.querySelector(`#${t}`);try{r.textContent="Loading Bundle wallets from the vault...";const o=await vn("bundle");if(o.length===0)throw new Error("No Bundle wallets saved for this project yet — generate some in the Wallets tab first.");o.length>e.length&&(r.textContent=`${o.length} Bundle wallets saved, but only ${e.length} buyer-row slot(s) exist (${a}) — using the first ${e.length}.`);let s=0;for(const i of o){if(s>=e.length)break;const{prefix:c,index:u}=e[s],d=document.querySelector(`#${c}BuyerKey${u}`),b=document.querySelector(`#${c}BuyerEnabled${u}`);!d||!b||(d.value=i.privateKey,b.checked=!0,s++)}r.textContent=`Filled ${s} Bundle wallet(s) into buyer rows (${a}). Set each row's ETH amount and minimum token output before validating/executing.`,w(`${n}: filled ${s} Bundle wallet(s) from the vault into buyer rows.`)}catch(o){r.textContent=A(o)}}function Vl(){return kt("ponsWalletsTabResult","Pons","ponsDevWalletSelect")}function Gl(){const e=[...Array.from({length:5},(t,n)=>({prefix:"ponsFastLane",index:n})),...et.flatMap(({prefix:t})=>Array.from({length:Ue},(n,a)=>({prefix:t,index:a})))];return Gt(e,"ponsWalletsTabResult","Pons","Fast Lane first, then Burst 1/2/3")}const St="pw";function io(){const e=St;return[...Array.from({length:5},(t,n)=>({prefix:`${e}ponsFastLane`,index:n})),...et.flatMap(({prefix:t})=>Array.from({length:Ue},(n,a)=>({prefix:`${e}${t}`,index:a})))]}function lo(){var n,a;const e=[],t=new Set;for(const{prefix:r,index:o}of io()){if(!((n=l[`${r}BuyerEnabled${o}`])!=null&&n.checked))continue;const s=(((a=l[`${r}BuyerKey${o}`])==null?void 0:a.value)||"").trim();if(!s)continue;const i=s.startsWith("0x")?s:`0x${s}`;if(!/^0x[0-9a-fA-F]{64}$/.test(i))continue;let c;try{c=new K(i).address.toLowerCase()}catch{continue}t.has(c)||(t.add(c),e.push(i))}return e}function zl(){const e=St;return`
  ...
  `}function Xl(){const e=St;return kt(`${e}ponsWashFillResult`,"Pons + Wash",`${e}ponsWashDevWalletSelect`)}async function y0(){const e=St,t=document.querySelector(`#${e}ponsWashFillResult`);await Gt(io(),`${e}ponsWashFillResult`,"Pons + Wash","Fast Lane first, then Burst 1/2/3");const n=lo();n.length>0&&(l[`${e}washBatchSellKeys`].value=n.join(`
...
Continue?`)){r("Combo cancelled before starting.");return}try{r("Phase 1 — Pons launch..."),await ho(r,e),r("Phase 2 — Fast Lane...");const i=await jn(`${e}ponsFastLane`,5,r,e);r(`Fast Lane done: ${i.confirmed}/${i.submitted} confirmed.`),r("Phase 3 — Burst sections...");let c=0,u=0;for(const{prefix:v,label:g}of et){const k=await jn(`${e}${v}`,Ue,r,e);r(`${g} done: ${k.confirmed}/${k.submitted} confirmed.`),c+=k.confirmed,u+=k.submitted}if(r(`Bundle complete. Token ${t.launchedToken}. Fast Lane ${i.confirmed}/${i.submitted}, Burst ${c}/${u} confirmed.`),!t.launchedToken)throw new Error("No launched token detected — not starting the wash.");let d=Ke(l[`${e}washBatchSellKeys`].value);d.length===0&&(d=lo(),l[`${e}washBatchSellKeys`].value=d.join(`
...
`),w(`Wallet Wash (Solana relay): ${a}`)};try{const a=l.washSellKey.value.trim();if(!a)throw new Error("Enter Wallet A's private key.");const r=l.washBuyKey.value.trim();if(!r)throw new Error("Enter Wallet B's private key.");const o=Math.max(0,parseFloat(l.washRelayGasReserve.value)||5e-4),s=Ha(l.washSolanaRpcUrl.value.trim()||"/api/solana-rpc"),i=Math.max(0,parseFloat(l.washSolanaGasReserve.value)||.002);n(`Using Solana RPC: ${s}`);const c=te(),u=new K(a.startsWith("0x")?a:`0x${a}`,c),d=new K(r.startsWith("0x")?r:`0x${r}`,c);if(u.address.toLowerCase()===d.address.toLowerCase())throw new Error("Wallet A and Wallet B must be different wallets — using the same one defeats the point of the relay.");const{generateSolanaKeypair:b,solanaSecretKeyToBase58:f,bridgeEthToSolana:p,bridgeSolanaToEth:h,waitForSolanaBalance:m}=await On(async()=>{const{generateSolanaKeypair:W,solanaSecretKeyToBase58:ae,bridgeEthToSolana:z,bridgeSolanaToEth:Z,waitForSolanaBalance:be}=await import("./cross-chain-relay-B8TWw15R.js").then(fe=>fe.k);return{generateSolanaKeypair:W,solanaSecretKeyToBase58:ae,bridgeEthToSolana:z,bridgeSolanaToEth:Z,waitForSolanaBalance:be}},__vite__mapDeps([0,1,2])),{Connection:v}=await On(async()=>{const{Connection:W}=await import("./index.browser.esm-YdP9aFGL.js").then(ae=>ae.i);return{Connection:W}},[]);if(n("Step 1/4 — Selling with Wallet A..."),await Zn(),document.querySelector("#washSellResult").textContent.toLowerCase().includes("failed")){e.textContent=`${e.textContent}
Sell failed — see Wallet A result above. Relay and buy were not attempted.`,w("Wallet Wash (Solana relay): sell failed, sequence stopped.");return}const g=Number(O(await c.getBalance(u.address)));if(g<=o)throw new Error(`Wallet A only has ${P(g)} ETH after selling — not enough above the ${o} gas reserve to bridge.`);const k=g-o,T=ce(P(k)),S=b(),E=S.publicKey.toBase58();n(`Generated disposable Solana relay wallet: ${E}`);try{const W=await ve("/api/wallets/save",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({chain:"solana",privateKeys:[f(S)],label:"wash-relay (solana): cross-chain pair"}),credentials:"same-origin"});W.ok?n("  saved Solana relay wallet to the wallet vault (Disperse tab)."):n(`  could not save Solana relay wallet to the vault (continuing anyway): ${(await W.json()).error||W.statusText}`)}catch(W){n(`  could not save Solana relay wallet to the vault (continuing anyway): ${A(W)}`)}n(`Step 2/4 — Bridging ${P(k)} ETH from Wallet A to ${R(E)} on Solana via Relay Protocol...`),await p({evmWallet:u,solanaKeypair:S,amountWei:T,solanaRpcUrl:s,onProgress:W=>{var z,Z;const ae=(Z=(z=W==null?void 0:W.txHashes)==null?void 0:z.at(-1))==null?void 0:Z.txHash;ae&&n(`  bridge tx: ${ae}`)}}),n("  bridge to Solana confirmed — waiting for the destination-side SOL to actually land (Relay's solver delivers this on its own schedule, a few seconds to a couple minutes after the deposit confirms)...");const L=new v(s,"confirmed"),M=Math.round(i*1e9),D=await m(L,S.publicKey,{minLamports:M+1,onPoll:W=>n(`  Solana relay wallet balance so far: ${W/1e9} SOL...`)}),I=D/1e9;n(`  Solana relay wallet balance: ${I} SOL`);const H=D-M;if(H<=0)throw new Error(`Solana relay wallet only received ${I} SOL after waiting — not enough above the ${i} SOL fee reserve to bridge back. It may still be in flight; check ${E} on solscan.io before retrying.`);n(`Step 3/4 — Bridging ${H/1e9} SOL from Solana back to Wallet B on Robinhood Chain...`),await h({solanaKeypair:S,evmRecipientAddress:d.address,amountLamports:H,solanaRpcUrl:s,onProgress:W=>{var z,Z;const ae=(Z=(z=W==null?void 0:W.txHashes)==null?void 0:z.at(-1))==null?void 0:Z.txHash;ae&&n(`  bridge tx: ${ae}`)}}),n("  bridge back to Robinhood Chain confirmed.");const V=Number(O(await c.getBalance(d.address))),F=Math.max(0,V-o);if(F<=0)throw new Error(`Wallet B received ${P(V)} ETH, which doesn't leave enough above the ${o} gas reserve to buy with.`);n(`Step 4/4 — Buying with Wallet B using ${P(F)} ETH...`),await Jn(ce(P(F)));const $=document.querySelector("#washBuyResult").textContent.toLowerCase().includes("failed");n($?"Buy failed — see Wallet B result above for details.":"Sequence complete: sold with Wallet A, bridged through Solana, bridged back, bought with Wallet B."),n(`Solana relay secret key (base58, for sweeping any leftover dust — also saved to the wallet vault above): ${f(S)}`)}catch(a){e.textContent=`${e.textContent}
